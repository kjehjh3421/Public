...
PID: 10681
Date: 2013-07-03 09:57:47(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 10681, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0xbe898d60
r2   = 0xbe898d78, r3   = 0x00000000
r4   = 0xbe898d60, r5   = 0xbe898d78
r6   = 0x005c3cb8, r7   = 0x00000000
r8   = 0xbe898d78, r9   = 0x00081dc0
r10  = 0xb46c0158, fp   = 0xbe898e20
ip   = 0xb418f250, sp   = 0xbe898d30
lr   = 0xb3bcaa2d, pc   = 0xb3bca8d6
cpsr = 0x88010030
...
b2e67000 b2e85000 r-xp /opt/usr/apps/docomo6003/bin/MyHondana.exe
...
Callstack Information (PID:10681)
Call Stack Count: 35
 0: Tizen::Ui::Controls::IconListView::Construct(Tizen::Graphics::FloatRectangle const&, Tizen::Graphics::FloatDimension const&, Tizen::Ui::Controls::IconListViewStyle, Tizen::Ui::Controls::IconListViewScrollDirection, Tizen::Ui::Controls::IconListViewScrollStyle) + 0x9 (0xb3bca8d6) [/usr/lib/osp/libosp-uifw.so] + 0x34e8d6
 1: Tizen::Ui::Controls::IconListView::Construct(Tizen::Graphics::Rectangle const&, Tizen::Graphics::Dimension const&, Tizen::Ui::Controls::IconListViewStyle, Tizen::Ui::Controls::IconListViewScrollDirection, Tizen::Ui::Controls::IconListViewScrollStyle) + 0x90 (0xb3bcaa2d) [/usr/lib/osp/libosp-uifw.so] + 0x34ea2d
 2: SortPopupPanel::Construct(Tizen::Graphics::Rectangle) + 0xd8 (0xb2e7e2f0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x172f0
 3: MyHondanaMainForm::SortMenu() + 0xfc (0xb2e7a5a0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x135a0
 4: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x158 (0xb2e7986c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1286c
 5: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2e7a654) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x13654
 6: (0xb3bdaf2b) [/usr/lib/osp/libosp-uifw.so] + 0x35ef2b
 7: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb44e7ec1) [/usr/lib/osp/libosp-appfw.so] + 0x151ec1
 8: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb44e80fb) [/usr/lib/osp/libosp-appfw.so] + 0x1520fb
 9: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb44e81ed) [/usr/lib/osp/libosp-appfw.so] + 0x1521ed
10: (0xb3cd34a7) [/usr/lib/osp/libosp-uifw.so] + 0x4574a7
11: (0xb3bd87c7) [/usr/lib/osp/libosp-uifw.so] + 0x35c7c7
12: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb44e7ec1) [/usr/lib/osp/libosp-appfw.so] + 0x151ec1
13: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb44e80fb) [/usr/lib/osp/libosp-appfw.so] + 0x1520fb
14: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb44e81ed) [/usr/lib/osp/libosp-appfw.so] + 0x1521ed
15: Tizen::Ui::Controls::_Button::FireActionEvent() + 0x26 (0xb3be1f7f) [/usr/lib/osp/libosp-uifw.so] + 0x365f7f
16: (0xb3be4b29) [/usr/lib/osp/libosp-uifw.so] + 0x368b29
17: Tizen::Ui::Controls::_Button::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0xe (0xb3bdfebb) [/usr/lib/osp/libosp-uifw.so] + 0x363ebb
18: Tizen::Ui::_ControlImpl::CallOnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x21a (0xb3b29a63) [/usr/lib/osp/libosp-uifw.so] + 0x2ada63
19: Tizen::Ui::_ControlImpl::_PropagatedTouchEventListener::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x20c (0xb3b3189d) [/usr/lib/osp/libosp-uifw.so] + 0x2b589d
20: Tizen::Ui::_UiTouchEvent::FireListener(Tizen::Ui::_ITouchEventListener const*, Tizen::Ui::_Control const*, bool, bool&) + 0x1aa (0xb3b89403) [/usr/lib/osp/libosp-uifw.so] + 0x30d403
21: Tizen::Ui::_UiTouchEvent::OnEventProcessing(Tizen::Ui::_Control const&, bool&) + 0x62 (0xb3b8980f) [/usr/lib/osp/libosp-uifw.so] + 0x30d80f
22: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb3b7dee3) [/usr/lib/osp/libosp-uifw.so] + 0x301ee3
23: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x6c (0xb3b7e7b1) [/usr/lib/osp/libosp-uifw.so] + 0x3027b1
24: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x1ec (0xb3b7ea09) [/usr/lib/osp/libosp-uifw.so] + 0x302a09
25: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0x8a (0xb3b7eaeb) [/usr/lib/osp/libosp-uifw.so] + 0x302aeb
26: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb3b7eb7b) [/usr/lib/osp/libosp-uifw.so] + 0x302b7b
27: (0xb3b6ec7f) [/usr/lib/osp/libosp-uifw.so] + 0x2f2c7f
28: (0xb3b7230f) [/usr/lib/osp/libosp-uifw.so] + 0x2f630f
29: (0xb6650aad) [/usr/lib/libecore.so.1] + 0x7aad
30: (0xb6654153) [/usr/lib/libecore.so.1] + 0xb153
31: ecore_main_loop_begin + 0x30 (0xb6654575) [/usr/lib/libecore.so.1] + 0xb575
32: elm_run + 0x6 (0xb6986c73) [/usr/lib/libelementary.so.1] + 0xa9c73
33: appcore_efl_main + 0x114 (0xb6d83268) [/usr/lib/libappcore-efl.so.1] + 0x6268
34: app_efl_main + 0xc6 (0xb4268ed3) [/usr/lib/libcapi-appfw-application.so.0] + 0x9ed3
End of Call Stack
