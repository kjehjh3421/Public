...
PID: 11088
Date: 2013-07-03 10:01:01(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 11088, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0xbe898d38
r2   = 0xbe898d50, r3   = 0x00000000
r4   = 0xbe898d38, r5   = 0xbe898d50
r6   = 0x005c3cb8, r7   = 0x00000000
r8   = 0xbe898d50, r9   = 0x00081a90
r10  = 0xb46c0158, fp   = 0xbe898df8
ip   = 0xb418f250, sp   = 0xbe898d08
...
b05a8000 b0da7000 rwxp [stack:11091]
...
Callstack Information (PID:11088)
Call Stack Count: 35
 ...
 2: SortPopupPanel::Construct(Tizen::Graphics::Rectangle) + 0xd8 (0xb2e7e3e0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x173e0
 3: MyHondanaMainForm::SortMenu() + 0x120 (0xb2e7a670) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x13670
 4: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x158 (0xb2e79918) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x12918
 5: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2e7a744) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x13744
