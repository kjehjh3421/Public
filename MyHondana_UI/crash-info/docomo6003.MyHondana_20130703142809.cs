...
PID: 26806
Date: 2013-07-03 14:28:09(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 26806, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000068b6
r2   = 0x00000006, r3   = 0x000068b6
r4   = 0x00000006, r5   = 0xb6c02be4
r6   = 0xb6c02000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xb4e409b4
r10  = 0xb6f3c000, fp   = 0xb46c0158
ip   = 0xb6f3c4c0, sp   = 0xbe898788
...
Callstack Information (PID:26806)
Call Stack Count: 19
 ...
 4: Tizen::App::_AppInfo::GetApplicationId() + 0x3c (0xb44a606d) [/usr/lib/osp/libosp-appfw.so] + 0x11006d
 5: Tizen::Io::_IpcClient::MakeConnection(bool) + 0x9c (0xb4528b05) [/usr/lib/osp/libosp-appfw.so] + 0x192b05
 6: Tizen::Io::_IpcClient::Construct(Tizen::Base::String const&, Tizen::Io::_IIpcClientEventListener const*) + 0x4c (0xb4529089) [/usr/lib/osp/libosp-appfw.so] + 0x193089
 7: Tizen::App::_AppManagerProxy::Construct() + 0x42 (0xb449757f) [/usr/lib/osp/libosp-appfw.so] + 0x10157f
 8: Tizen::App::_AppManagerProxy::GetService() + 0x4a (0xb449763f) [/usr/lib/osp/libosp-appfw.so] + 0x10163f
 9: (0xb448ec69) [/usr/lib/osp/libosp-appfw.so] + 0xf8c69
10: Tizen::App::AppManager::Construct() + 0x2a (0xb448d407) [/usr/lib/osp/libosp-appfw.so] + 0xf7407
11: Tizen::App::AppManager::GetInstance() + 0x36 (0xb448d623) [/usr/lib/osp/libosp-appfw.so] + 0xf7623
12: Tizen::App::_AppManagerImpl::GetInstance() + 0x6 (0xb448ecb3) [/usr/lib/osp/libosp-appfw.so] + 0xf8cb3
13: (0xb44990cb) [/usr/lib/osp/libosp-appfw.so] + 0x1030cb
14: (0xb44991dd) [/usr/lib/osp/libosp-appfw.so] + 0x1031dd
15: Tizen::App::AppResource::GetInstance() + 0x28 (0xb4498d5d) [/usr/lib/osp/libosp-appfw.so] + 0x102d5d
16: Tizen::App::App::GetAppResource() const + 0x6 (0xb4485523) [/usr/lib/osp/libosp-appfw.so] + 0xef523
17: global constructors keyed to a + 0x2c (0xb2e71f78) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x9f78
18: (0xb6f2d7f0) [/lib/ld-linux.so.3] + 0xe7f0
End of Call Stack
