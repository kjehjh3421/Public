...
PID: 2567
Date: 2013-07-04 16:00:57(GMT+0900)
...
Call Stack Count: 38
 ...
 5: MyHondanaMainForm::OptionMenu() + 0x114 (0xb2e79cd4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x11cd4
 6: MyHondanaMainForm::OnInitializing() + 0x80 (0xb2e79440) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x11440
...
19: MyHondanaFrame::OnInitializing() + 0x64 (0xb2e785f0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x105f0
...
29: MyHondanaApp::OnAppInitialized() + 0x88 (0xb2e74a5c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0xca5c
