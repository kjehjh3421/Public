...
PID: 22905
Date: 2013-07-05 15:16:46(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 22905, uid 5000)

Register Information
r0   = 0x00000041, r1   = 0x001c1570
r2   = 0xb46b2b48, r3   = 0xb46c0158
r4   = 0xb418e598, r5   = 0x001c1570
r6   = 0xbe898948, r7   = 0x001c1570
r8   = 0x00000000, r9   = 0x00000300
r10  = 0x00000001, fp   = 0xbe898978
ip   = 0xb418edd0, sp   = 0xbe898900
lr   = 0xb3b0ab39, pc   = 0xb3b33180
cpsr = 0x680f0030
...
Callstack Information (PID:22905)
Call Stack Count: 35
 0: Tizen::Ui::_ContainerImpl::GetPublic() const + 0x7 (0xb3b33180) [/usr/lib/osp/libosp-uifw.so] + 0x2b7180
 1: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x10 (0xb3b0ab39) [/usr/lib/osp/libosp-uifw.so] + 0x28eb39
 2: MyHondanaMainForm::SetSplitPanel() + 0xcc (0xb2e789ac) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x119ac
 3: MyHondanaMainForm::OnInitializing() + 0x78 (0xb2e78558) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x11558
 4: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb3b27fb7) [/usr/lib/osp/libosp-uifw.so] + 0x2abfb7
 5: Tizen::Ui::Controls::_FormImpl::OnAttachedToMainTree() + 0x28 (0xb3ce39ed) [/usr/lib/osp/libosp-uifw.so] + 0x4679ed
 6: Tizen::Ui::_Control::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0xb2 (0xb3b10793) [/usr/lib/osp/libosp-uifw.so] + 0x294793
 7: Tizen::Ui::_Control::EndAttaching(Tizen::Ui::_Control&) + 0xec (0xb3b1390d) [/usr/lib/osp/libosp-uifw.so] + 0x29790d
 8: Tizen::Ui::_Control::AttachChild(Tizen::Ui::_Control&) + 0x5a (0xb3b162ff) [/usr/lib/osp/libosp-uifw.so] + 0x29a2ff
 9: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xa4 (0xb3b334c1) [/usr/lib/osp/libosp-uifw.so] + 0x2b74c1
10: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb3b0ab4f) [/usr/lib/osp/libosp-uifw.so] + 0x28eb4f
11: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0xb3b0abdb) [/usr/lib/osp/libosp-uifw.so] + 0x28ebdb
12: (0xb3daccc7) [/usr/lib/osp/libosp-uifw.so] + 0x530cc7
13: (0xb3dad60f) [/usr/lib/osp/libosp-uifw.so] + 0x53160f
14: (0xb3db018d) [/usr/lib/osp/libosp-uifw.so] + 0x53418d
15: Tizen::Ui::Scenes::SceneManager::GoForward(Tizen::Ui::Scenes::ForwardSceneTransition const&, Tizen::Base::Collection::IList const*) + 0x18 (0xb3da4c95) [/usr/lib/osp/libosp-uifw.so] + 0x528c95
16: MyHondanaFrame::OnInitializing() + 0x64 (0xb2e77710) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x10710
17: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb3b27fb7) [/usr/lib/osp/libosp-uifw.so] + 0x2abfb7
18: Tizen::Ui::Controls::_FrameImpl::OnAttachedToMainTree() + 0xa (0xb3ce690b) [/usr/lib/osp/libosp-uifw.so] + 0x46a90b
19: Tizen::Ui::_ControlManager::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0x76 (0xb3b3731f) [/usr/lib/osp/libosp-uifw.so] + 0x2bb31f
20: Tizen::Ui::_ControlManager::ActivateWindow(Tizen::Ui::_Window&, bool) + 0xcc (0xb3b37d4d) [/usr/lib/osp/libosp-uifw.so] + 0x2bbd4d
21: Tizen::Ui::_ControlManager::OpenWindow(Tizen::Ui::_Window&, bool) + 0x2e (0xb3b37f5f) [/usr/lib/osp/libosp-uifw.so] + 0x2bbf5f
22: Tizen::Ui::_Window::Open(bool) + 0x3c (0xb3b25275) [/usr/lib/osp/libosp-uifw.so] + 0x2a9275
23: Tizen::Ui::_WindowImpl::Open(bool) + 0x12 (0xb3b352eb) [/usr/lib/osp/libosp-uifw.so] + 0x2b92eb
24: Tizen::App::_UiAppImpl::AddFrame(Tizen::Ui::Controls::Frame const&) + 0x40 (0xb3ee4309) [/usr/lib/osp/libosp-uifw.so] + 0x668309
25: Tizen::App::UiApp::AddFrame(Tizen::Ui::Controls::Frame const&) + 0x14 (0xb3ee36cd) [/usr/lib/osp/libosp-uifw.so] + 0x6676cd
26: MyHondanaApp::OnAppInitialized() + 0x88 (0xb2e73b7c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0xcb7c
27: Tizen::App::_UiAppImpl::OnAppInitialized() + 0x18 (0xb3ee3bb1) [/usr/lib/osp/libosp-uifw.so] + 0x667bb1
28: Tizen::App::_AppImpl::OnService(service_s*, void*) + 0x1da (0xb448652f) [/usr/lib/osp/libosp-appfw.so] + 0xf052f
29: (0xb4268bdd) [/usr/lib/libcapi-appfw-application.so.0] + 0x9bdd
30: (0xb6d7ff28) [/usr/lib/libappcore-efl.so.1] + 0x2f28
31: (0xb528b94c) [/usr/lib/libappcore-common.so.1] + 0x194c
32: (0xb528c024) [/usr/lib/libappcore-common.so.1] + 0x2024
33: (0xb6518225) [/usr/lib/libaul.so.0] + 0x3225
dladdr failed 34: (0x84938) (null)
End of Call Stack
