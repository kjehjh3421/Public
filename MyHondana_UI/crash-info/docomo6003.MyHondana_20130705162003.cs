...
PID: 28003
Date: 2013-07-05 16:20:03(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 28003, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000001
r2   = 0x00000006, r3   = 0xb46c0158
r4   = 0x001b8f98, r5   = 0x00000300
r6   = 0x00000001, r7   = 0xbe898890
r8   = 0x00000448, r9   = 0x001c1828
r10  = 0x00000001, fp   = 0xbe898978
ip   = 0xb41904ac, sp   = 0xbe898870
...
Callstack Information (PID:28003)
Call Stack Count: 35
 ...
 2: MyHondanaMainForm::SetThumbnailView() + 0x27c (0xb2e79af0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x12af0
 3: MyHondanaMainForm::OnInitializing() + 0x88 (0xb2e785b0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x115b0
...
16: MyHondanaFrame::OnInitializing() + 0x64 (0xb2e77924) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x10924
...
26: MyHondanaApp::OnAppInitialized() + 0x88 (0xb2e73d90) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0xcd90
