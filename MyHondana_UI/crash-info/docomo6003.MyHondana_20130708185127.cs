...
PID: 25551
Date: 2013-07-08 18:51:27(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 25551, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000063cf
r2   = 0x00000006, r3   = 0x000063cf
r4   = 0x00000006, r5   = 0xb6c58be4
r6   = 0xb6c58000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xbeff5acc
r10  = 0xb6f92000, fp   = 0xbeff5978
ip   = 0xb6f924c0, sp   = 0xbeff4dd8
...
Callstack Information (PID:25551)
Call Stack Count: 38
 ...
 4: Tizen::Ui::Controls::ContextMenu::AddItem(Tizen::Base::String const&, int, Tizen::Graphics::Bitmap const&, Tizen::Graphics::Bitmap const*, Tizen::Graphics::Bitmap const*) + 0xaa (0xb3c1166b) [/usr/lib/osp/libosp-uifw.so] + 0x33f66b
 5: MyHondanaMainForm::OptionMenu() + 0x168 (0xb2ece7c4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x147c4
 6: MyHondanaMainForm::OnInitializing() + 0xac (0xb2ecb704) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x11704
...
19: MyHondanaFrame::OnInitializing() + 0x64 (0xb2ecaa64) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x10a64
...
29: MyHondanaApp::OnAppInitialized() + 0x88 (0xb2ec6ea8) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0xcea8
