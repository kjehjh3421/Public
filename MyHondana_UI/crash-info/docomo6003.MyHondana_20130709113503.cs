...
PID: 25471
Date: 2013-07-09 11:35:03(GMT+0900)
...
r4   = 0x001b8118, r5   = 0x001b4b50
r6   = 0x00000001, r7   = 0x00449e08
r8   = 0xbeff6008, r9   = 0x0039fff8
...
Call Stack Count: 32
 ...
 2: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x164 (0xb2ecdce8) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x19ce8
 3: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2ecdfd4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x19fd4
