...
PID: 26624
Date: 2013-07-09 11:45:47(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 26624, uid 5000)

Register Information
r0   = 0x0000005f, r1   = 0x00000001
r2   = 0x00000081, r3   = 0xb2ee4130
r4   = 0x001b81a0, r5   = 0x001b4bd8
r6   = 0x00000001, r7   = 0x0044a5f8
r8   = 0xbeff6008, r9   = 0x003a0070
...
b05ee000 b0ded000 rwxp [stack:26626]
...
Callstack Information (PID:26624)
Call Stack Count: 32
 ...
 2: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x164 (0xb2ecde28) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x19e28
 3: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2ece114) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1a114
