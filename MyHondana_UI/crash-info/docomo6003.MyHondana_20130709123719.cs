...
PID: 27218
Date: 2013-07-09 12:37:19(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 27218, uid 5000)

Register Information
r0   = 0x0000005f, r1   = 0x00000001
r2   = 0x00000081, r3   = 0xb2ee4130
r4   = 0x001b81e8, r5   = 0x001b4c20
r6   = 0x00000001, r7   = 0x00449fa0
r8   = 0xbeff6008, r9   = 0x003a00c8
...
b05ee000 b0ded000 rwxp [stack:27220]
...
Callstack Information (PID:27218)
Call Stack Count: 32
 ...
 2: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x164 (0xb2ecdd10) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x19d10
 3: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2ecdffc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x19ffc
