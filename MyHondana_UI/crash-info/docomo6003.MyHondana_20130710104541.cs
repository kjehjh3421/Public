...
PID: 25296
Date: 2013-07-10 10:45:41(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 25296, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000062d0
r2   = 0x00000006, r3   = 0x000062d0
r4   = 0x00000006, r5   = 0xb6c58be4
r6   = 0xb6c58000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xb4e969b4
r10  = 0xb6f92000, fp   = 0xb4716158
ip   = 0xb6f924c0, sp   = 0xbeff54a8
...
b2ea4000 b2eda000 r-xp /opt/usr/apps/docomo6003/bin/MyHondana.exe
...
Callstack Information (PID:25296)
Call Stack Count: 20
 ...
 4: Tizen::App::_AppInfo::GetApplicationId() + 0x3c (0xb44fc06d) [/usr/lib/osp/libosp-appfw.so] + 0x11006d
 5: Tizen::Io::_IpcClient::MakeConnection(bool) + 0x9c (0xb457eb05) [/usr/lib/osp/libosp-appfw.so] + 0x192b05
 6: Tizen::Io::_IpcClient::Construct(Tizen::Base::String const&, Tizen::Io::_IIpcClientEventListener const*) + 0x4c (0xb457f089) [/usr/lib/osp/libosp-appfw.so] + 0x193089
 7: Tizen::App::_AppManagerProxy::Construct() + 0x42 (0xb44ed57f) [/usr/lib/osp/libosp-appfw.so] + 0x10157f
 8: Tizen::App::_AppManagerProxy::GetService() + 0x4a (0xb44ed63f) [/usr/lib/osp/libosp-appfw.so] + 0x10163f
 9: (0xb44e4c69) [/usr/lib/osp/libosp-appfw.so] + 0xf8c69
10: Tizen::App::AppManager::Construct() + 0x2a (0xb44e3407) [/usr/lib/osp/libosp-appfw.so] + 0xf7407
11: Tizen::App::AppManager::GetInstance() + 0x36 (0xb44e3623) [/usr/lib/osp/libosp-appfw.so] + 0xf7623
12: Tizen::App::_AppManagerImpl::GetInstance() + 0x6 (0xb44e4cb3) [/usr/lib/osp/libosp-appfw.so] + 0xf8cb3
13: (0xb44ef0cb) [/usr/lib/osp/libosp-appfw.so] + 0x1030cb
14: (0xb44ef1dd) [/usr/lib/osp/libosp-appfw.so] + 0x1031dd
15: Tizen::App::AppResource::GetInstance() + 0x28 (0xb44eed5d) [/usr/lib/osp/libosp-appfw.so] + 0x102d5d
16: Tizen::App::App::GetAppResource() const + 0x6 (0xb44db523) [/usr/lib/osp/libosp-appfw.so] + 0xef523
17: __cxx_global_var_init + 0x40 (0xb2eaeafc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0xaafc
18: global constructors keyed to a + 0xc (0xb2eafff0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0xbff0
19: (0xb6f837f0) [/lib/ld-linux.so.3] + 0xe7f0
End of Call Stack
