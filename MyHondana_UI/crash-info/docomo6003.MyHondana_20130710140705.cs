...
PID: 11985
Date: 2013-07-10 14:07:05(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 11985, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000002d0
r2   = 0x000010e0, r3   = 0x0000ffff
r4   = 0xb41e4598, r5   = 0xbeff57f0
r6   = 0x00000000, r7   = 0xbeff57d0
r8   = 0xa00009cb, r9   = 0xbeff59dc
r10  = 0x00000001, fp   = 0xbeff5850
ip   = 0xb3c1dbc1, sp   = 0xbeff47c0
lr   = 0xb3c1dbe5, pc   = 0xb3d424d8
cpsr = 0x88000030
...
b05dd000 b0ddc000 rwxp [stack:11987]
...
Callstack Information (PID:11985)
Call Stack Count: 35
 0: (0xb3d424d8) [/usr/lib/osp/libosp-uifw.so] + 0x4704d8
 1: Tizen::Ui::Controls::Label::Construct(Tizen::Graphics::Rectangle const&, Tizen::Base::String const&) + 0x24 (0xb3c1dbe5) [/usr/lib/osp/libosp-uifw.so] + 0x34bbe5
 2: MyHondanaMainForm::SetButton() + 0x288 (0xb2ec24a0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1f4a0
 3: MyHondanaMainForm::OnInitializing() + 0xdc (0xb2ec0a84) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1da84
...
16: MyHondanaFrame::OnInitializing() + 0xc4 (0xb2ebf9bc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1c9bc
...
26: MyHondanaApp::OnAppInitialized() + 0x100 (0xb2eb3c8c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x10c8c
