...
PID: 13352
Date: 2013-07-10 21:16:59(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 13352, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000002d0
r2   = 0x000002d0, r3   = 0x0000ffff
r4   = 0xb41e4598, r5   = 0xbeff57f8
r6   = 0x00000000, r7   = 0xbeff57d8
r8   = 0xa00009cb, r9   = 0xbeff59dc
r10  = 0x00000001, fp   = 0xbeff5850
ip   = 0xb3c1dbc1, sp   = 0xbeff4790
...
00018000 00094000 rw-p [heap]
00094000 002de000 rw-p [heap]
b0611000 b0615000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b061e000 b0e1d000 rwxp [stack:13354]
...
Callstack Information (PID:13352)
Call Stack Count: 35
 ...
 2: MyHondanaMainForm::SetButton() + 0x1e0 (0xb2ec0ca4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1fca4
 3: MyHondanaMainForm::OnInitializing() + 0xdc (0xb2ebf328) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1e328
...
16: MyHondanaFrame::OnInitializing() + 0xc4 (0xb2ebe168) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1d168
...
26: MyHondanaApp::OnAppInitialized() + 0x100 (0xb2eb20cc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x110cc
