...
PID: 18634
Date: 2013-07-10 21:48:41(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 18634, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000048ca
r2   = 0x00000006, r3   = 0x000048ca
r4   = 0x00000006, r5   = 0xb6c58be4
r6   = 0xb6c58000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xbeff59dc
r10  = 0xb6f92000, fp   = 0xbeff5850
ip   = 0xb6f924c0, sp   = 0xbeff4080
...
00074000 0030c000 rw-p [heap]
b0611000 b0615000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b061e000 b0e1d000 rwxp [stack:18636]
b0e1d000 b0f6b000 r-xp /usr/lib/r3p2/libMali.so
b0f77000 b0f9f000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b0fa3000 b0fc1000 r-xp /usr/lib/osp/libtestbuddy.so.1.0
b0fd3000 b0fd9000 r-xp /usr/lib/libUMP.so
...
b2ea1000 b2edb000 r-xp /opt/usr/apps/docomo6003/bin/MyHondana.exe
...
Callstack Information (PID:18634)
Call Stack Count: 38
 ...
 5: MyHondanaMainForm::SetButton() + 0x2c4 (0xb2ec0d88) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1fd88
 6: MyHondanaMainForm::OnInitializing() + 0xdc (0xb2ebf328) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1e328
...
19: MyHondanaFrame::OnInitializing() + 0xc4 (0xb2ebe168) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1d168
...
29: MyHondanaApp::OnAppInitialized() + 0x100 (0xb2eb20cc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x110cc
