...
PID: 14647
Date: 2013-07-11 14:32:41(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 14647, uid 5000)
...
b05e0000 b0ddf000 rwxp [stack:14649]
...
Callstack Information (PID:14647)
Call Stack Count: 27
 0: Tizen::Base::String::String(Tizen::Base::String const&) + 0x19 (0xb44f45d2) [/usr/lib/osp/libosp-appfw.so] + 0x13b5d2
 1: MyHondanaMainForm::CreateItem(int) + 0x290 (0xb2e91384) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x35384
 2: non-virtual thunk to MyHondanaMainForm::CreateItem(int) + 0x2c (0xb2e92dd4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x36dd4
