...
PID: 22443
Date: 2013-07-11 17:36:12(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 22443, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000057ab
r2   = 0x00000006, r3   = 0x000057ab
r4   = 0x00000006, r5   = 0xb6c25be4
r6   = 0xb6c25000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00481180
r10  = 0xb6f5f000, fp   = 0xbecfbe10
ip   = 0xb6f5f4c0, sp   = 0xbecfb810
...
ac6aa000 ac6ac000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b05d4000 b05d8000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b05e1000 b0de0000 rwxp [stack:22445]
...
Callstack Information (PID:22443)
Call Stack Count: 36
 ...
 4: Tizen::Ui::Control::SetShowState(bool) + 0x3e (0xb3b302ab) [/usr/lib/osp/libosp-uifw.so] + 0x2912ab
 5: SortPopupPanel::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x1c8 (0xb2e9cf78) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x3ff78
 6: non-virtual thunk to SortPopupPanel::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2e9d00c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x4000c
 7: (0xb3bfdf2b) [/usr/lib/osp/libosp-uifw.so] + 0x35ef2b
 8: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb450aec1) [/usr/lib/osp/libosp-appfw.so] + 0x151ec1
 9: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb450b0fb) [/usr/lib/osp/libosp-appfw.so] + 0x1520fb
10: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb450b1ed) [/usr/lib/osp/libosp-appfw.so] + 0x1521ed
11: (0xb3cf8733) [/usr/lib/osp/libosp-uifw.so] + 0x459733
12: (0xb3bfb7c7) [/usr/lib/osp/libosp-uifw.so] + 0x35c7c7
13: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb450aec1) [/usr/lib/osp/libosp-appfw.so] + 0x151ec1
14: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb450b0fb) [/usr/lib/osp/libosp-appfw.so] + 0x1520fb
15: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb450b1ed) [/usr/lib/osp/libosp-appfw.so] + 0x1521ed
16: Tizen::Ui::Controls::_CheckButton::FireActionEvent() + 0x7c (0xb3c12b8d) [/usr/lib/osp/libosp-uifw.so] + 0x373b8d
17: (0xb3c18d45) [/usr/lib/osp/libosp-uifw.so] + 0x379d45
18: Tizen::Ui::Controls::_CheckButton::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0xe (0xb3c1051f) [/usr/lib/osp/libosp-uifw.so] + 0x37151f
19: Tizen::Ui::_ControlImpl::CallOnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x21a (0xb3b4ca63) [/usr/lib/osp/libosp-uifw.so] + 0x2ada63
20: Tizen::Ui::_ControlImpl::_PropagatedTouchEventListener::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x20c (0xb3b5489d) [/usr/lib/osp/libosp-uifw.so] + 0x2b589d
21: Tizen::Ui::_UiTouchEvent::FireListener(Tizen::Ui::_ITouchEventListener const*, Tizen::Ui::_Control const*, bool, bool&) + 0x1aa (0xb3bac403) [/usr/lib/osp/libosp-uifw.so] + 0x30d403
22: Tizen::Ui::_UiTouchEvent::OnEventProcessing(Tizen::Ui::_Control const&, bool&) + 0x62 (0xb3bac80f) [/usr/lib/osp/libosp-uifw.so] + 0x30d80f
23: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb3ba0ee3) [/usr/lib/osp/libosp-uifw.so] + 0x301ee3
24: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x6c (0xb3ba17b1) [/usr/lib/osp/libosp-uifw.so] + 0x3027b1
25: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x1ec (0xb3ba1a09) [/usr/lib/osp/libosp-uifw.so] + 0x302a09
26: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0x8a (0xb3ba1aeb) [/usr/lib/osp/libosp-uifw.so] + 0x302aeb
27: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb3ba1b7b) [/usr/lib/osp/libosp-uifw.so] + 0x302b7b
28: (0xb3b91c7f) [/usr/lib/osp/libosp-uifw.so] + 0x2f2c7f
29: (0xb3b9530f) [/usr/lib/osp/libosp-uifw.so] + 0x2f630f
30: (0xb6673aad) [/usr/lib/libecore.so.1] + 0x7aad
31: (0xb6677153) [/usr/lib/libecore.so.1] + 0xb153
32: ecore_main_loop_begin + 0x30 (0xb6677575) [/usr/lib/libecore.so.1] + 0xb575
33: elm_run + 0x6 (0xb69a9c73) [/usr/lib/libelementary.so.1] + 0xa9c73
34: appcore_efl_main + 0x114 (0xb6da6268) [/usr/lib/libappcore-efl.so.1] + 0x6268
35: app_efl_main + 0xc6 (0xb428bed3) [/usr/lib/libcapi-appfw-application.so.0] + 0x9ed3
End of Call Stack
