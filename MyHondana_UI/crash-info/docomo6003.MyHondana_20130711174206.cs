...
PID: 23810
Date: 2013-07-11 17:42:06(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 23810, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0xb2eb1440, r3   = 0x000010a0
r4   = 0xb2e9cfc0, r5   = 0x004a0e40
r6   = 0x004c7890, r7   = 0x004d3d48
r8   = 0xbecfbf28, r9   = 0x022a7d98
r10  = 0xb46e3158, fp   = 0xbecfbdb8
ip   = 0xb41b34ac, sp   = 0xbecfbd90
lr   = 0xb3b2e685, pc   = 0xb3b4a408
cpsr = 0x68000030
...
00070000 027ec000 rw-p [heap]
ae7e6000 ae7e8000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b0591000 b0595000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b059e000 b0d9d000 rwxp [stack:23812]
...
Callstack Information (PID:23810)
Call Stack Count: 34
 0: Tizen::Ui::_ControlImpl::GetFullScreenSizeInfo() + 0x53 (0xb3b4a408) [/usr/lib/osp/libosp-uifw.so] + 0x2ab408
 1: Tizen::Ui::Control::Destroy() + 0x8 (0xb3b2e685) [/usr/lib/osp/libosp-uifw.so] + 0x28f685
 2: MyHondanaMainForm::SortMenuHide() + 0x24 (0xb2e946a4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x376a4
 3: SortPopupPanel::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x1c4 (0xb2e9cf6c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x3ff6c
 4: non-virtual thunk to SortPopupPanel::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2e9cffc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x3fffc
