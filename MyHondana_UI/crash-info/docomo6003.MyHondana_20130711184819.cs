...
PID: 26228
Date: 2013-07-11 18:48:19(GMT+0900)
...
r2   = 0x3194fd00, r3   = 0x3194fd00
r4   = 0xffff0759, r5   = 0x004a0f58
r6   = 0x00000000, r7   = 0x004d3e80
r8   = 0xbecfbf28, r9   = 0x00481808
r10  = 0xb46e3158, fp   = 0xbecfbdb0
ip   = 0xb41b34ac, sp   = 0xbecfbd70
...
b059e000 b0d9d000 rwxp [stack:26230]
...
Call Stack Count: 34
 ...
 2: MyHondanaMainForm::SortMenuHide(bool) + 0x68 (0xb2e946e8) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x376e8
 3: SortPopupPanel::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x1c8 (0xb2e9cfd4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x3ffd4
 4: non-virtual thunk to SortPopupPanel::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2e9d07c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x4007c
