...
PID: 32091
Date: 2013-07-12 21:39:48(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 32091, uid 5000)

Register Information
r0   = 0x004c57e8, r1   = 0x00000002
r2   = 0x004e0530, r3   = 0x004c57e8
r4   = 0xb2eb3104, r5   = 0x004c57f0
r6   = 0x004e0530, r7   = 0x004e31d8
r8   = 0xbeea3f50, r9   = 0x004651c0
r10  = 0xb4724158, fp   = 0xbeea3e38
ip   = 0xb2ef2744, sp   = 0xbeea3da0
lr   = 0xb2eb2f60, pc   = 0xb2eb2fe0
cpsr = 0x68000010
...
b05e1000 b0de0000 rwxp [stack:32093]
...
Callstack Information (PID:32091)
Call Stack Count: 31
 0: DeletePopupPanel::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xb0 (0xb2eb2fe0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x12fe0
 1: non-virtual thunk to DeletePopupPanel::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2eb3140) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x13140
