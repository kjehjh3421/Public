...
PID: 6677
Date: 2013-07-12 23:35:15(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 6677, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00001a15
r2   = 0x00000006, r3   = 0x00001a15
r4   = 0x00000006, r5   = 0xb6c66be4
r6   = 0xb6c66000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00081ab8
r10  = 0xb6fa0000, fp   = 0xbeea41a4
ip   = 0xb6fa04c0, sp   = 0xbeea3b08
...
00071000 00823000 rw-p [heap]
abc38000 ac437000 rwxp [stack:6701]
ac438000 acc37000 rwxp [stack:6699]
acc37000 acc38000 r-xp /usr/lib/evas/modules/loaders/eet/linux-gnueabi-armv7l-1.7.99/module.so
acc41000 ad440000 rwxp [stack:6698]
ad440000 ad442000 r-xp /usr/lib/remix/libtizen_sound_player.so.1.0.0
ad44a000 ad44c000 r-xp /usr/lib/remix/libeet_sndfile_reader.so
ad455000 ad456000 r-xp /usr/lib/edje/modules/multisense_factory/linux-gnueabi-armv7l-1.0.0/module.so
ad465000 ad47c000 r-xp /usr/lib/edje/modules/elm/linux-gnueabi-armv7l-1.0.0/module.so
ad7a4000 ad7ad000 r-xp /usr/lib/libefl-assist.so.0.1.0
ad7b6000 adfb5000 rwxp [stack:6697]
adfb6000 ae7b5000 rwxp [stack:6696]
b05ca000 b05ce000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b05d7000 b0dd6000 rwxp [stack:6679]
b0dd6000 b0f24000 r-xp /usr/lib/r3p2/libMali.so
b0f30000 b0f58000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b0f5c000 b0f7a000 r-xp /usr/lib/osp/libtestbuddy.so.1.0
b0f89000 b0f93000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b12cd000 b1319000 r-xp /usr/lib/pulseaudio/libpulsecommon-4.0.so
b1322000 b1327000 r-xp /usr/lib/libjson.so.0.0.1
b132f000 b1333000 r-xp /usr/lib/liblocation-pos-log.so
b133b000 b134d000 r-xp /usr/lib/libmmfile_utils.so.0.0.0
b1355000 b1357000 r-xp /usr/lib/libmedia-hash.so.1.0.0
b135f000 b1364000 r-xp /usr/lib/libmmutil_jpeg.so.0.0.0
b136c000 b1377000 r-xp /usr/lib/libdrm-trusted.so.0.0.52
b137f000 b1381000 r-xp /usr/lib/libmedia-svc-hash.so.1.0.0
b1389000 b1396000 r-xp /usr/lib/libdrm-client.so.0.0.90
b139f000 b13a7000 r-xp /usr/lib/lib_SamsungRec_V03010.so
b13c9000 b1400000 r-xp /usr/lib/libpulse.so.0.16.2
b1408000 b146c000 r-xp /usr/lib/libasound.so.2.0.0
b1476000 b1479000 r-xp /usr/lib/libpulse-simple.so.0.0.4
b1482000 b1486000 r-xp /usr/lib/libascenario-0.2.so.0.0.0
b148f000 b14ac000 r-xp /usr/lib/libavsysaudio.so.0.0.1
b14b4000 b14b9000 r-xp /usr/lib/libmmfsoundcommon.so.0.0.0
b14c1000 b14ee000 r-xp /usr/lib/libSLP-location.so.0.0.0
b14f7000 b1500000 r-xp /usr/lib/libdownload-provider-interface.so.1.0.7
b1508000 b150c000 r-xp /usr/lib/libmmffile.so.0.0.0
b1514000 b151b000 r-xp /usr/lib/libmedia-utils.so.0.0.0
b1524000 b153e000 r-xp /usr/lib/libmedia-thumbnail.so.1.0.0
b1546000 b1561000 r-xp /usr/lib/libmedia-service.so.1.0.0
b1569000 b1574000 r-xp /usr/lib/libmdm-common.so.1.0.37
b157c000 b158a000 r-xp /usr/lib/libbookmark-adaptor.so.0.2.7
b1593000 b159a000 r-xp /usr/lib/libenchant.so.1.6.1
b15a2000 b15a5000 r-xp /usr/lib/libcapi-telephony-network-info.so.0.1.8
b15ae000 b15b7000 r-xp /usr/lib/libcapi-system-sensor.so.0.1.17
b15c0000 b15c4000 r-xp /usr/lib/libmmfsession.so.0.0.0
b15cd000 b15dc000 r-xp /usr/lib/libmmfsound.so.0.1.0
b15e4000 b15e9000 r-xp /usr/lib/libmemenv.so.1.1.0
b15f1000 b162f000 r-xp /usr/lib/libleveldb.so.1.1.0
b1638000 b1662000 r-xp /usr/lib/libgstaudio-0.10.so.0.25.0
b166b000 b166d000 r-xp /usr/lib/libsecfw.so
b1675000 b167e000 r-xp /usr/lib/libaudio-session-mgr.so.0.0.0
b1689000 b1698000 r-xp /usr/lib/libgstvideo-0.10.so.0.25.0
b16a0000 b16b8000 r-xp /usr/lib/libgstpbutils-0.10.so.0.25.0
b16ba000 b16c7000 r-xp /usr/lib/libgstinterfaces-0.10.so.0.25.0
b16d0000 b16d9000 r-xp /usr/lib/libgstapp-0.10.so.0.25.0
b16e1000 b1723000 r-xp /usr/lib/libgstbase-0.10.so.0.30.0
b172c000 b17c8000 r-xp /usr/lib/libgstreamer-0.10.so.0.30.0
b17d4000 b17f9000 r-xp /usr/lib/libxslt.so.1.1.16
b1802000 b1804000 r-xp /usr/lib/libewebkit2-ext.so.1.0.2
b180c000 b1814000 r-xp /usr/lib/libui-gadget-1.so.0.1.0
b181c000 b1827000 r-xp /usr/lib/libcapi-location-manager.so.0.1.12
b182f000 b1832000 r-xp /usr/lib/libcapi-web-url-download.so.0.1.0
b183a000 b183f000 r-xp /usr/lib/libcapi-media-metadata-extractor.so
b1847000 b186e000 r-xp /usr/lib/libcapi-content-media-content.so.0.2.70
b1876000 b188c000 r-xp /usr/lib/osp/libosp-locations.so.1.2.1.0
b1895000 b18d2000 r-xp /usr/lib/libmdm.so.1.0.63
b18da000 b18ef000 r-xp /usr/lib/libnetwork.so.0.0.0
b18f7000 b1900000 r-xp /usr/lib/libcapi-web-favorites.so
b1908000 b2b60000 r-xp /usr/lib/libewebkit2.so.0.10.144.6
b2c53000 b2ca6000 r-xp /usr/lib/osp/libosp-content.so.1.2.2.0
b2caf000 b2cc6000 r-xp /usr/lib/libwifi-direct.so.0.0
b2cce000 b2cd6000 r-xp /usr/lib/libcapi-network-wifi.so.0.1.7
b2cde000 b2ce7000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2cef000 b2cf9000 r-xp /usr/lib/libcapi-network-connection.so.0.1.10
b2d01000 b2d65000 r-xp /usr/lib/osp/libosp-web.so.1.2.2.0
b2d72000 b2e27000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b2e34000 b2e4e000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2e57000 b2e75000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2e81000 b2e87000 r-xp /usr/lib/libUMP.so
b2e96000 b2ee8000 r-xp /opt/usr/apps/docomo6003/bin/MyHondana.exe
...
Call Stack Count: 12
 ...
 4: Tizen::App::_UiAppImpl::OnAppInitialized() + 0xba (0xb3f47c53) [/usr/lib/osp/libosp-uifw.so] + 0x667c53
 5: Tizen::App::_AppImpl::OnService(service_s*, void*) + 0x1da (0xb44ea52f) [/usr/lib/osp/libosp-appfw.so] + 0xf052f
 6: (0xb42ccbdd) [/usr/lib/libcapi-appfw-application.so.0] + 0x9bdd
 7: (0xb6de3f28) [/usr/lib/libappcore-efl.so.1] + 0x2f28
 8: (0xb52ef94c) [/usr/lib/libappcore-common.so.1] + 0x194c
 9: (0xb52f0024) [/usr/lib/libappcore-common.so.1] + 0x2024
10: (0xb657c225) [/usr/lib/libaul.so.0] + 0x3225
dladdr failed 11: (0x83240) (null)
End of Call Stack
