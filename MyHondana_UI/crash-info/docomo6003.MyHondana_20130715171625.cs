...
PID: 18041
Date: 2013-07-15 17:16:25(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 18041, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00004679
r2   = 0x00000006, r3   = 0x00004679
r4   = 0x00000006, r5   = 0xb6c3ebe4
r6   = 0xb6c3e000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xbea2e7dc
r10  = 0xb6f78000, fp   = 0xbea2e658
ip   = 0xb6f784c0, sp   = 0xbea2d528
...
00070000 02446000 rw-p [heap]
af93f000 af941000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af998000 b0197000 rwxp [stack:18056]
b059e000 b05a2000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b05ab000 b0daa000 rwxp [stack:18043]
...
Callstack Information (PID:18041)
Call Stack Count: 49
 ...
 4: Tizen::Ui::Controls::Slider::SetBarBackgroundColor(Tizen::Graphics::Color const&) + 0x3a (0xb3c11adb) [/usr/lib/osp/libosp-uifw.so] + 0x359adb
 5: MyHondanaSettingForm::SetButton() + 0xd7c (0xb2eac534) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x42534
 6: MyHondanaSettingForm::OnInitializing() + 0xb0 (0xb2eaac94) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x40c94
...
19: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xaf0 (0xb2e9e834) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x34834
20: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2e9e96c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x3496c
