...
PID: 18464
Date: 2013-07-15 17:23:44(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 18464, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00004820
r2   = 0x00000006, r3   = 0x00004820
...
Callstack Information (PID:18464)
Call Stack Count: 49
 ...
 5: MyHondanaSettingForm::SetButton() + 0xd7c (0xb2eac6fc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x426fc
 6: MyHondanaSettingForm::OnInitializing() + 0xb0 (0xb2eaae5c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x40e5c
...
19: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xaf0 (0xb2e9e918) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x34918
20: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2e9ea50) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x34a50
