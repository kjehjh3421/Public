...
PID: 11570
Date: 2013-07-16 15:31:34(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 11570, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00002d32
r2   = 0x00000006, r3   = 0x00002d32
r4   = 0x00000006, r5   = 0xb6c3ebe4
r6   = 0xb6c3e000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00a4b1f0
...
0007a000 01086000 rw-p [heap]
af93c000 af93e000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af995000 b0194000 rwxp [stack:11584]
b059b000 b059f000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b05a8000 b0da7000 rwxp [stack:11572]
...
Callstack Information (PID:11570)
Call Stack Count: 24
 ...
 5: MyHondanaDeleteForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x4c (0xb2e856fc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1e6fc
 6: non-virtual thunk to MyHondanaDeleteForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x3c (0xb2e85804) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x1e804
