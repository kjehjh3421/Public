...
PID: 5654
Date: 2013-07-17 21:32:07(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 5654, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00001616
r2   = 0x00000006, r3   = 0x00001616
...
0007b000 00a1d000 rw-p [heap]
af93b000 af93d000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af994000 b0193000 rwxp [stack:5670]
b059a000 b059e000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b05a7000 b0da6000 rwxp [stack:5656]
...
Callstack Information (PID:5654)
Call Stack Count: 49
 ...
 5: MyHondanaSettingForm::SetButton() + 0xf88 (0xb2eabef4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x45ef4
 6: MyHondanaSettingForm::OnInitializing() + 0xb0 (0xb2eaa4dc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x444dc
...
19: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xaf0 (0xb2e9debc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x37ebc
20: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2e9dff4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x37ff4
