...
PID: 31432
Date: 2013-07-18 14:16:13(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 31432, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00007ac8
r2   = 0x00000006, r3   = 0x00007ac8
r4   = 0x00000006, r5   = 0xb6c3ebe4
r6   = 0xb6c3e000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x001c1fa4
r10  = 0xb6f78000, fp   = 0x00000000
ip   = 0xb6f784c0, sp   = 0xbea2e360
...
00018000 0007c000 rw-p [heap]
0007c000 022b2000 rw-p [heap]
adf74000 adf76000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af98b000 b018a000 rwxp [stack:31446]
b0591000 b0595000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b059e000 b0d9d000 rwxp [stack:31434]
...
b2e5d000 b2ec0000 r-xp /opt/usr/apps/docomo6003/bin/MyHondana.exe
...
Callstack Information (PID:31432)
Call Stack Count: 38
 ...
 4: Tizen::Ui::Control::Invalidate(bool) + 0x3c (0xb3b47801) [/usr/lib/osp/libosp-uifw.so] + 0x28f801
 5: (0xb3de9331) [/usr/lib/osp/libosp-uifw.so] + 0x531331
 6: (0xb3dec18d) [/usr/lib/osp/libosp-uifw.so] + 0x53418d
 7: Tizen::Ui::Scenes::SceneManager::GoForward(Tizen::Ui::Scenes::ForwardSceneTransition const&, Tizen::Base::Collection::IList const*) + 0x18 (0xb3de0c95) [/usr/lib/osp/libosp-uifw.so] + 0x528c95
 8: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xbc4 (0xb2e97860) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x3a860
 9: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2e9799c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x3a99c
10: (0xb3c16f2b) [/usr/lib/osp/libosp-uifw.so] + 0x35ef2b
...
14: (0xb3d1362f) [/usr/lib/osp/libosp-uifw.so] + 0x45b62f
15: (0xb3c147c7) [/usr/lib/osp/libosp-uifw.so] + 0x35c7c7
16: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb4523ec1) [/usr/lib/osp/libosp-appfw.so] + 0x151ec1
17: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb45240fb) [/usr/lib/osp/libosp-appfw.so] + 0x1520fb
18: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb45241ed) [/usr/lib/osp/libosp-appfw.so] + 0x1521ed
19: (0xb3c40807) [/usr/lib/osp/libosp-uifw.so] + 0x388807
20: Tizen::Ui::Controls::_ContextMenu::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0xe (0xb3c3a33b) [/usr/lib/osp/libosp-uifw.so] + 0x38233b
21: Tizen::Ui::_ControlImpl::CallOnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x21a (0xb3b65a63) [/usr/lib/osp/libosp-uifw.so] + 0x2ada63
22: Tizen::Ui::_ControlImpl::_PropagatedTouchEventListener::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x20c (0xb3b6d89d) [/usr/lib/osp/libosp-uifw.so] + 0x2b589d
23: Tizen::Ui::_UiTouchEvent::FireListener(Tizen::Ui::_ITouchEventListener const*, Tizen::Ui::_Control const*, bool, bool&) + 0x1aa (0xb3bc5403) [/usr/lib/osp/libosp-uifw.so] + 0x30d403
24: Tizen::Ui::_UiTouchEvent::OnEventProcessing(Tizen::Ui::_Control const&, bool&) + 0x62 (0xb3bc580f) [/usr/lib/osp/libosp-uifw.so] + 0x30d80f
25: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb3bb9ee3) [/usr/lib/osp/libosp-uifw.so] + 0x301ee3
26: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x6c (0xb3bba7b1) [/usr/lib/osp/libosp-uifw.so] + 0x3027b1
27: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x1ec (0xb3bbaa09) [/usr/lib/osp/libosp-uifw.so] + 0x302a09
28: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0x8a (0xb3bbaaeb) [/usr/lib/osp/libosp-uifw.so] + 0x302aeb
29: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb3bbab7b) [/usr/lib/osp/libosp-uifw.so] + 0x302b7b
30: (0xb3baac7f) [/usr/lib/osp/libosp-uifw.so] + 0x2f2c7f
31: (0xb3bae30f) [/usr/lib/osp/libosp-uifw.so] + 0x2f630f
32: (0xb668caad) [/usr/lib/libecore.so.1] + 0x7aad
33: (0xb6690153) [/usr/lib/libecore.so.1] + 0xb153
34: ecore_main_loop_begin + 0x30 (0xb6690575) [/usr/lib/libecore.so.1] + 0xb575
35: elm_run + 0x6 (0xb69c2c73) [/usr/lib/libelementary.so.1] + 0xa9c73
36: appcore_efl_main + 0x114 (0xb6dbf268) [/usr/lib/libappcore-efl.so.1] + 0x6268
37: app_efl_main + 0xc6 (0xb42a4ed3) [/usr/lib/libcapi-appfw-application.so.0] + 0x9ed3
End of Call Stack
