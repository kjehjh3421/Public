...
PID: 6454
Date: 2013-07-22 17:38:27(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 6454, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00001936
r2   = 0x00000006, r3   = 0x00001936
r4   = 0x00000006, r5   = 0xb6c5bbe4
r6   = 0xb6c5b000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x9e313ab0
...
00071000 05eb6000 rw-p [heap]
ace39000 ace4a000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
ada6b000 ada6d000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af1b6000 af1bb000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
af927000 b0126000 rwxp [stack:6469]
b052d000 b0531000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b053a000 b0d39000 rwxp [stack:6456]
...
Callstack Information (PID:6454)
Call Stack Count: 25
 ...
 5: MyHondanaDetailForm::SetListView() + 0xb20 (0xb2e33468) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x29468
 6: MyHondanaDetailForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0xd4 (0xb2e38420) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x2e420
 7: non-virtual thunk to MyHondanaDetailForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x3c (0xb2e38558) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x2e558
