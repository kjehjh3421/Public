...
PID: 15250
Date: 2013-07-22 21:53:26(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 15250, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0xb1e0fb00, r3   = 0xb1e0fb00
r4   = 0xb2e6c9b5, r5   = 0xfffec1ee
r6   = 0x00000000, r7   = 0x03c272d8
r8   = 0xbecdaed0, r9   = 0x03567e58
r10  = 0xb46f89d0, fp   = 0xbecdadb8
ip   = 0xb41c0ed8, sp   = 0xbecdad50
...
00072000 03ee2000 rw-p [heap]
adb80000 adb82000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af926000 b0125000 rwxp [stack:15265]
b0196000 b01a7000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b01b0000 b01b5000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b052c000 b0530000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0539000 b0d38000 rwxp [stack:15252]
...
Callstack Information (PID:15250)
Call Stack Count: 35
 ...
 2: MyHondanaViewerMoveForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x12c (0xb2e62430) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x59430
 3: non-virtual thunk to MyHondanaViewerMoveForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2e624ac) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x594ac
End of Call Stack
