...
PID: 15717
Date: 2013-07-22 21:57:58(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 15717, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000001
r2   = 0xb1e0fb00, r3   = 0x00000000
r4   = 0xb41bef70, r5   = 0xa9e527c4
r6   = 0x00000001, r7   = 0xaa054f70
r8   = 0xbecdb4f0, r9   = 0xaaf38cc0
r10  = 0xb46f89d0, fp   = 0xbecdb3a0
ip   = 0xb41c0ed8, sp   = 0xbecdb1c8
lr   = 0xb3b36e5f, pc   = 0xb3b51188
cpsr = 0x680f0030
...
00072000 0194e000 rw-p [heap]
ade2f000 ade31000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af373000 af384000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
af926000 b0125000 rwxp [stack:15730]
...
b0539000 b0d38000 rwxp [stack:15719]
...
Callstack Information (PID:15717)
Call Stack Count: 22
 0: Tizen::Ui::_ControlImpl::GetFullScreenSizeInfo() + 0x53 (0xb3b51188) [/usr/lib/osp/libosp-uifw.so] + 0x2ae188
 1: Tizen::Ui::Control::SetShowState(bool) + 0xa (0xb3b36e5f) [/usr/lib/osp/libosp-uifw.so] + 0x293e5f
 2: MyHondanaViewerMoveForm::ConstructPanel(bool) + 0x4dc (0xb2e61ed8) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x58ed8
 3: MyHondanaViewerMoveForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x40 (0xb2e62680) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x59680
 4: non-virtual thunk to MyHondanaViewerMoveForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x3c (0xb2e626e8) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x596e8
 5: Tizen::Ui::_PublicOrientationEvent::FireImpl(Tizen::Base::Runtime::IEventListener&, Tizen::Base::Runtime::IEventArg const&) + 0x6c (0xb3b95209) [/usr/lib/osp/libosp-uifw.so] + 0x2f2209
 6: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb451d985) [/usr/lib/osp/libosp-appfw.so] + 0x154985
 7: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb451dbbf) [/usr/lib/osp/libosp-appfw.so] + 0x154bbf
 8: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb451dcb1) [/usr/lib/osp/libosp-appfw.so] + 0x154cb1
End of Call Stack
