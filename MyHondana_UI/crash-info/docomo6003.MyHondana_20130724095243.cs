...
PID: 9311
Date: 2013-07-24 09:52:43(GMT+0900)
...
r0   = 0x00000000, r1   = 0x0000245f
r2   = 0x00000006, r3   = 0x0000245f
r4   = 0x00000006, r5   = 0xb6ca5be4
r6   = 0xb6ca5000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00551100
r10  = 0xb6fe0000, fp   = 0xbeae42b0
ip   = 0xb6fe04c0, sp   = 0xbeae3a78
...
Call Stack Count: 26
 ...
 7: MyHondanaMainForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x44 (0xb2e93c94) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x41c94
 8: non-virtual thunk to MyHondanaMainForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x3c (0xb2e9454c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x4254c
 9: Tizen::Ui::_PublicOrientationEvent::FireImpl(Tizen::Base::Runtime::IEventListener&, Tizen::Base::Runtime::IEventArg const&) + 0x6c (0xb3bdf209) [/usr/lib/osp/libosp-uifw.so] + 0x2f2209
10: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb4567985) [/usr/lib/osp/libosp-appfw.so] + 0x154985
11: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb4567bbf) [/usr/lib/osp/libosp-appfw.so] + 0x154bbf
12: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb4567cb1) [/usr/lib/osp/libosp-appfw.so] + 0x154cb1
End of Call Stack
