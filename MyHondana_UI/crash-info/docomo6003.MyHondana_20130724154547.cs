...
PID: 11211
Date: 2013-07-24 15:45:47(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 11211, uid 5000)

Register Information
r0   = 0x0000005f, r1   = 0x026152b8
r2   = 0x0000005f, r3   = 0xb47429d0
r4   = 0xb4208f70, r5   = 0x026152c4
r6   = 0x02ab1fd8, r7   = 0x0154f988
r8   = 0xbeae44f0, r9   = 0x005601c8
r10  = 0xb47429d0, fp   = 0xbeae43d8
ip   = 0xb420aed8, sp   = 0xbeae4340
lr   = 0xb3b7f26d, pc   = 0xb3b9b188
cpsr = 0x68000030
...
00091000 02f24000 rw-p [heap]
ae8b8000 ae8ba000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af96f000 b016e000 rwxp [stack:11227]
b039f000 b03b0000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b03b9000 b03be000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0575000 b0579000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0582000 b0d81000 rwxp [stack:11213]
...
Callstack Information (PID:11211)
Call Stack Count: 21
 0: Tizen::Ui::_ControlImpl::GetFullScreenSizeInfo() + 0x53 (0xb3b9b188) [/usr/lib/osp/libosp-uifw.so] + 0x2ae188
 1: Tizen::Ui::Control::Destroy() + 0x8 (0xb3b7f26d) [/usr/lib/osp/libosp-uifw.so] + 0x29226d
 2: MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x114 (0xb2eab24c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5924c
 3: non-virtual thunk to MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x3c (0xb2eab388) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x59388
 4: Tizen::Ui::_PublicOrientationEvent::FireImpl(Tizen::Base::Runtime::IEventListener&, Tizen::Base::Runtime::IEventArg const&) + 0x6c (0xb3bdf209) [/usr/lib/osp/libosp-uifw.so] + 0x2f2209
 5: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb4567985) [/usr/lib/osp/libosp-appfw.so] + 0x154985
 6: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb4567bbf) [/usr/lib/osp/libosp-appfw.so] + 0x154bbf
 7: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb4567cb1) [/usr/lib/osp/libosp-appfw.so] + 0x154cb1
End of Call Stack
