...
PID: 12976
Date: 2013-07-24 16:00:39(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 12976, uid 5000)

Register Information
r0   = 0x0000005f, r1   = 0x03334010
r2   = 0x0000005f, r3   = 0xb47429d0
r4   = 0xb4208f70, r5   = 0x0333401c
r6   = 0x03a32100, r7   = 0x039fd7f8
r8   = 0xbeae44f0, r9   = 0x034be848
...
00091000 03ea3000 rw-p [heap]
adb89000 adb8b000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
ae81b000 ae82c000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
ae835000 ae83a000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
af96f000 b016e000 rwxp [stack:12992]
b0575000 b0579000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0582000 b0d81000 rwxp [stack:12978]
...
Callstack Information (PID:12976)
Call Stack Count: 21
 ...
 2: MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x114 (0xb2eab380) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x59380
 3: non-virtual thunk to MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x3c (0xb2eab4bc) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x594bc
