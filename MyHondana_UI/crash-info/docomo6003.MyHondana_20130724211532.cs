...
PID: 24124
Date: 2013-07-24 21:15:32(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 24124, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00005e3c
r2   = 0x00000006, r3   = 0x00005e3c
r4   = 0x00000006, r5   = 0xb6ca5be4
r6   = 0xb6ca5000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x0174a6f0
r10  = 0xb6fe0000, fp   = 0xbeae43d8
ip   = 0xb6fe04c0, sp   = 0xbeae3dd8
...
00072000 02183000 rw-p [heap]
ade2f000 ade31000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af96f000 b016e000 rwxp [stack:24140]
b02df000 b02f0000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b02f9000 b02fe000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0575000 b0579000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0582000 b0d81000 rwxp [stack:24126]
...
Callstack Information (PID:24124)
Call Stack Count: 24
 ...
 4: Tizen::Ui::Control::Destroy() + 0x36 (0xb3b7f29b) [/usr/lib/osp/libosp-uifw.so] + 0x29229b
 5: MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x38 (0xb2eab2a4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x592a4
 6: non-virtual thunk to MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x3c (0xb2eab3e0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x593e0
 7: Tizen::Ui::_PublicOrientationEvent::FireImpl(Tizen::Base::Runtime::IEventListener&, Tizen::Base::Runtime::IEventArg const&) + 0x6c (0xb3bdf209) [/usr/lib/osp/libosp-uifw.so] + 0x2f2209
 8: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb4567985) [/usr/lib/osp/libosp-appfw.so] + 0x154985
 9: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb4567bbf) [/usr/lib/osp/libosp-appfw.so] + 0x154bbf
10: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb4567cb1) [/usr/lib/osp/libosp-appfw.so] + 0x154cb1
End of Call Stack
