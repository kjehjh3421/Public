...
PID: 28492
Date: 2013-07-24 22:17:36(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 28492, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00006f4c
r2   = 0x00000006, r3   = 0x00006f4c
r4   = 0x00000006, r5   = 0xb6ca5be4
r6   = 0xb6ca5000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x006d4cc8
r10  = 0xb6fe0000, fp   = 0xbeae3dc8
ip   = 0xb6fe04c0, sp   = 0xbeae3800
...
b0581000 b0d80000 rwxp [stack:28494]
...
Callstack Information (PID:28492)
Call Stack Count: 36
 ...
 4: Tizen::Ui::Control::GetControlAnimator() const + 0x2e (0xb3b82387) [/usr/lib/osp/libosp-uifw.so] + 0x295387
 5: MyHondanaViewerForm::Play() + 0x78 (0xb2eaaf3c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x59f3c
 6: MyHondanaViewerForm::OnAdjustmentValueChanged(Tizen::Ui::Control const&, int) + 0x38 (0xb2eab968) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5a968
 7: non-virtual thunk to MyHondanaViewerForm::OnAdjustmentValueChanged(Tizen::Ui::Control const&, int) + 0x3c (0xb2eab9c8) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5a9c8
End of Call Stack
