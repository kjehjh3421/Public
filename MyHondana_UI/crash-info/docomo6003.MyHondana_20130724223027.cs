...
PID: 28614
Date: 2013-07-24 22:30:27(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 28614, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x008b3cf8
r2   = 0x00000000, r3   = 0x00000000
r4   = 0xb2eab98c, r5   = 0x008b3d04
r6   = 0x01c90678, r7   = 0x01db3a58
r8   = 0xbeae3f10, r9   = 0xab675450
...
00072000 02046000 rw-p [heap]
adf4c000 adf4e000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
ae730000 ae741000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
ae74a000 ae74f000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
af96e000 b016d000 rwxp [stack:28628]
b0574000 b0578000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0581000 b0d80000 rwxp [stack:28616]
...
Callstack Information (PID:28614)
Call Stack Count: 33
 ...
 3: MyHondanaViewerForm::OnAdjustmentValueChanged(Tizen::Ui::Control const&, int) + 0x38 (0xb2eab968) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5a968
 4: non-virtual thunk to MyHondanaViewerForm::OnAdjustmentValueChanged(Tizen::Ui::Control const&, int) + 0x3c (0xb2eab9c8) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5a9c8
End of Call Stack
