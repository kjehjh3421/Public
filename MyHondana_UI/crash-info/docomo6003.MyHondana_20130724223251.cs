...
PID: 29078
Date: 2013-07-24 22:32:51(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 29078, uid 5000)

Register Information
r0   = 0x3c090a3e, r1   = 0x02c45610
r2   = 0x3c090a3e, r3   = 0x00000000
r4   = 0xb2eab9a4, r5   = 0x02c4561c
r6   = 0x03b86880, r7   = 0x03b59598
r8   = 0xbeae3f10, r9   = 0x03477e80
r10  = 0xb47429d0, fp   = 0xbeae3dc8
ip   = 0xb4209eac, sp   = 0xbeae3d90
lr   = 0xb3b8235f, pc   = 0xb3b9b18c
cpsr = 0x480f0030
...
00072000 03ea4000 rw-p [heap]
adb88000 adb8a000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af96e000 b016d000 rwxp [stack:29094]
b048a000 b049b000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b04a4000 b04a9000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0574000 b0578000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0581000 b0d80000 rwxp [stack:29080]
...
Callstack Information (PID:29078)
Call Stack Count: 33
 0: Tizen::Ui::_ControlImpl::GetInstance(Tizen::Ui::Control&) + 0x3 (0xb3b9b18c) [/usr/lib/osp/libosp-uifw.so] + 0x2ae18c
 1: Tizen::Ui::Control::GetControlAnimator() const + 0x6 (0xb3b8235f) [/usr/lib/osp/libosp-uifw.so] + 0x29535f
 2: MyHondanaViewerForm::Play() + 0x78 (0xb2eaaf3c) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x59f3c
 3: MyHondanaViewerForm::OnAdjustmentValueChanged(Tizen::Ui::Control const&, int) + 0x38 (0xb2eab980) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5a980
 4: non-virtual thunk to MyHondanaViewerForm::OnAdjustmentValueChanged(Tizen::Ui::Control const&, int) + 0x3c (0xb2eab9e0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5a9e0
End of Call Stack
