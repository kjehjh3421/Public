...
PID: 29469
Date: 2013-07-24 22:35:12(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 29469, uid 5000)

Register Information
r0   = 0x01ca7218, r1   = 0x01720e34
r2   = 0x00000001, r3   = 0x00000018
r4   = 0xb4208f70, r5   = 0x01ca7218
r6   = 0x01c80c58, r7   = 0x017528f8
r8   = 0xbeae44f0, r9   = 0x017b4278
r10  = 0xb47429d0, fp   = 0xbeae4408
ip   = 0xb420aed8, sp   = 0xbeae4398
lr   = 0xb3b7f26d, pc   = 0xb3b7f278
cpsr = 0x88000030
...
b0581000 b0d80000 rwxp [stack:29471]
...
Call Stack Count: 19
 0: Tizen::Ui::Control::Destroy() + 0x13 (0xb3b7f278) [/usr/lib/osp/libosp-uifw.so] + 0x292278
 1: MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x38 (0xb2eaafa0) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x59fa0
 2: Tizen::Ui::_PublicOrientationEvent::FireImpl(Tizen::Base::Runtime::IEventListener&, Tizen::Base::Runtime::IEventArg const&) + 0x6c (0xb3bdf209) [/usr/lib/osp/libosp-uifw.so] + 0x2f2209
 3: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb4567985) [/usr/lib/osp/libosp-appfw.so] + 0x154985
 4: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb4567bbf) [/usr/lib/osp/libosp-appfw.so] + 0x154bbf
 5: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb4567cb1) [/usr/lib/osp/libosp-appfw.so] + 0x154cb1
End of Call Stack
