...
PID: 496
Date: 2013-07-24 23:08:02(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 496, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000001f0
r2   = 0x00000006, r3   = 0x000001f0
r4   = 0x00000006, r5   = 0xb6ca5be4
r6   = 0xb6ca5000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xabe40d28
r10  = 0xb6fe0000, fp   = 0xbeae4408
ip   = 0xb6fe04c0, sp   = 0xbeae3e08
...
b0581000 b0d80000 rwxp [stack:499]
...
Call Stack Count: 23
 ...
 5: MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x38 (0xb2eab0b8) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5a0b8
 6: Tizen::Ui::_PublicOrientationEvent::FireImpl(Tizen::Base::Runtime::IEventListener&, Tizen::Base::Runtime::IEventArg const&) + 0x6c (0xb3bdf209) [/usr/lib/osp/libosp-uifw.so] + 0x2f2209
 7: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb4567985) [/usr/lib/osp/libosp-appfw.so] + 0x154985
 8: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb4567bbf) [/usr/lib/osp/libosp-appfw.so] + 0x154bbf
 9: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb4567cb1) [/usr/lib/osp/libosp-appfw.so] + 0x154cb1
End of Call Stack
