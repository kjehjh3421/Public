...
PID: 889
Date: 2013-07-24 23:09:13(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 889, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000379
r2   = 0x00000006, r3   = 0x00000379
r4   = 0x00000006, r5   = 0xb6ca5be4
r6   = 0xb6ca5000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x0175c128
...
00072000 020f1000 rw-p [heap]
adf4c000 adf4e000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af96e000 b016d000 rwxp [stack:907]
...
b0581000 b0d80000 rwxp [stack:895]
...
Call Stack Count: 23
 ...
 5: MyHondanaViewerForm::OnOrientationChanged(Tizen::Ui::Control const&, Tizen::Ui::OrientationStatus) + 0x38 (0xb2eab0d4) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x5a0d4
