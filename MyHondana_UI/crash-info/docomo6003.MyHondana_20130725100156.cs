...
PID: 3625
Date: 2013-07-25 10:01:56(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 3625, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000e29
r2   = 0x00000006, r3   = 0x00000e29
r4   = 0x00000006, r5   = 0xb6ca5be4
r6   = 0xb6ca5000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0xbeae3884
r10  = 0xb6fe0000, fp   = 0xbeae36e0
ip   = 0xb6fe04c0, sp   = 0xbeae2368
...
00072000 0193a000 rw-p [heap]
ade2f000 ade31000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af96e000 b016d000 rwxp [stack:3640]
b01ca000 b01db000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b01e4000 b01e9000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0574000 b0578000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0581000 b0d80000 rwxp [stack:3627]
...
Callstack Information (PID:3625)
Call Stack Count: 46
 ...
 4: Tizen::Ui::Controls::Slider::SetValue(int) + 0x38 (0xb3c49e09) [/usr/lib/osp/libosp-uifw.so] + 0x35ce09
 5: MyHondanaViewerForm::SetButton() + 0x2390 (0xb2ea9c88) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x58c88
 6: MyHondanaViewerForm::OnInitializing() + 0xd8 (0xb2ea7128) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x56128
 7: non-virtual thunk to MyHondanaViewerForm::OnInitializing() + 0x20 (0xb2eaaaec) [/opt/apps/docomo6003/bin/MyHondana.exe] + 0x59aec
