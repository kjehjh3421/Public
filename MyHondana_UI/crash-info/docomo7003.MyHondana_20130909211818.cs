...
PID: 18163
Date: 2013-09-09 21:18:18(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 18163, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000046f3
r2   = 0x00000006, r3   = 0x000046f3
r4   = 0x00000006, r5   = 0xb6c10be4
r6   = 0xb6c10000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00000001
r10  = 0xb6f50000, fp   = 0xbe856ca0
ip   = 0xb6f504c0, sp   = 0xbe856558
lr   = 0xb6b1755c, pc   = 0xb6b13760
cpsr = 0x28000010
...
01816000 018c1000 rw-p [heap]
018c1000 050ed000 rw-p [heap]
a1af1000 a1e89000 rw-s anon_inode:dmabuf
a2068000 a2400000 rw-s anon_inode:dmabuf
a37da000 a394f000 rw-s anon_inode:dmabuf
a3950000 a414f000 rwxp [stack:18292]
a503a000 a51af000 rw-s anon_inode:dmabuf
a556a000 a5d69000 rwxp [stack:18287]
a5d6a000 a6569000 rwxp [stack:18286]
a656a000 a6d69000 rwxp [stack:18284]
a6d6a000 a7569000 rwxp [stack:18283]
a78d4000 a80d3000 rwxp [stack:18277]
a8e6a000 a9202000 rw-s anon_inode:dmabuf
a9202000 a959a000 rw-s anon_inode:dmabuf
ab122000 ab297000 rw-s anon_inode:dmabuf
ab38e000 ab503000 rw-s anon_inode:dmabuf
ac9fa000 ac9fc000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
ad2dd000 ad45b000 rw-s anon_inode:dmabuf
ad45b000 ad5d9000 rw-s anon_inode:dmabuf
adb17000 adeaf000 rw-s anon_inode:dmabuf
ae262000 ae263000 r-xp /usr/lib/evas/modules/loaders/eet/linux-gnueabi-armv7l-1.7.99/module.so
ae26b000 ae26d000 r-xp /usr/lib/remix/libeet_sndfile_reader.so
ae276000 ae278000 r-xp /usr/lib/remix/libtizen_sound_player.so.1.0.0
ae881000 aec19000 rw-s anon_inode:dmabuf
af26f000 af270000 r-xp /usr/lib/edje/modules/multisense_factory/linux-gnueabi-armv7l-1.0.0/module.so
af27f000 af296000 r-xp /usr/lib/edje/modules/elm/linux-gnueabi-armv7l-1.0.0/module.so
afb8e000 b038d000 rwxp [stack:18165]
...
Callstack Information (PID:18163)
Call Stack Count: 49
 0: gsignal + 0x3c (0xb6b13760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b1755c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6b0c63c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertInternal + 0x7a (0xb46f94e3) [/usr/lib/osp/libosp-appfw.so] + 0x13c4e3
 4: Tizen::Ui::_ContainerImpl::RemoveChild(Tizen::Ui::_ControlImpl*, bool) + 0xfc (0xb3ada31d) [/usr/lib/osp/libosp-uifw.so] + 0x2c831d
 5: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xbc (0xb3ada43d) [/usr/lib/osp/libosp-uifw.so] + 0x2c843d
 6: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb3aaef9f) [/usr/lib/osp/libosp-uifw.so] + 0x29cf9f
 7: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0xb3aaf02b) [/usr/lib/osp/libosp-uifw.so] + 0x29d02b
 8: MyHondanaMainForm::OnListViewItemStateChanged(Tizen::Ui::Controls::ListView&, int, int, Tizen::Ui::Controls::ListItemStatus) + 0x234 (0xb25340d0) [/opt/apps/docomo7003/bin/MyHondana.exe] + 0x470d0
 9: non-virtual thunk to MyHondanaMainForm::OnListViewItemStateChanged(Tizen::Ui::Controls::ListView&, int, int, Tizen::Ui::Controls::ListItemStatus) + 0x64 (0xb2534418) [/opt/apps/docomo7003/bin/MyHondana.exe] + 0x47418
End of Call Stack
