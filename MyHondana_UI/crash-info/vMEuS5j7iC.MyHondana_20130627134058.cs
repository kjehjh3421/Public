...
PID: 7098
Date: 2013-06-27 13:40:58(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 7098, uid 5000)
      TIMER: -2

Register Information
r0   = 0x00000000, r1   = 0x00001bba
r2   = 0x00000006, r3   = 0x00001bba
r4   = 0x00000006, r5   = 0xb6c15be4
r6   = 0xb6c15000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00000330
r10  = 0xb6f4f000, fp   = 0xbecfe8d8
ip   = 0xb6f4f4c0, sp   = 0xbecfdb18
lr   = 0xb6b1c55c, pc   = 0xb6b18760
cpsr = 0x28070010
...
Callstack Information (PID:7098)
Call Stack Count: 39
 0: gsignal + 0x3c (0xb6b18760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b1c55c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6b1163c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertfInternal + 0x9e (0xb44f6ddf) [/usr/lib/osp/libosp-appfw.so] + 0x13cddf
 4: Tizen::Ui::TouchFlickGestureDetector::AddFlickGestureEventListener(Tizen::Ui::ITouchFlickGestureEventListener&) + 0x3a (0xb3baa3e3) [/usr/lib/osp/libosp-uifw.so] + 0x3123e3
 5: MyHondanaMainForm::SetCoverFlowView() + 0xfac (0xb2e99730) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x11730
 6: MyHondanaMainForm::SetSplitPanel() + 0x1bc (0xb2e96eb0) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0xeeb0
 7: MyHondanaMainForm::OnInitializing() + 0x6c (0xb2e96a1c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0xea1c
 8: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb3b42563) [/usr/lib/osp/libosp-uifw.so] + 0x2aa563
 9: Tizen::Ui::Controls::_FormImpl::OnAttachedToMainTree() + 0x28 (0xb3cfa6c9) [/usr/lib/osp/libosp-uifw.so] + 0x4626c9
10: Tizen::Ui::_Control::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0xb2 (0xb3b2adbf) [/usr/lib/osp/libosp-uifw.so] + 0x292dbf
11: Tizen::Ui::_Control::EndAttaching(Tizen::Ui::_Control&) + 0xec (0xb3b2df19) [/usr/lib/osp/libosp-uifw.so] + 0x295f19
12: Tizen::Ui::_Control::AttachChild(Tizen::Ui::_Control&) + 0x5a (0xb3b3090b) [/usr/lib/osp/libosp-uifw.so] + 0x29890b
13: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xa4 (0xb3b4da6d) [/usr/lib/osp/libosp-uifw.so] + 0x2b5a6d
14: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb3b2517b) [/usr/lib/osp/libosp-uifw.so] + 0x28d17b
15: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0xb3b25207) [/usr/lib/osp/libosp-uifw.so] + 0x28d207
16: (0xb3dc2b57) [/usr/lib/osp/libosp-uifw.so] + 0x52ab57
17: (0xb3dc349f) [/usr/lib/osp/libosp-uifw.so] + 0x52b49f
18: (0xb3dc601d) [/usr/lib/osp/libosp-uifw.so] + 0x52e01d
19: Tizen::Ui::Scenes::SceneManager::GoForward(Tizen::Ui::Scenes::ForwardSceneTransition const&, Tizen::Base::Collection::IList const*) + 0x18 (0xb3dbab25) [/usr/lib/osp/libosp-uifw.so] + 0x522b25
20: MyHondanaFrame::OnInitializing() + 0x64 (0xb2e9598c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0xd98c
21: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb3b42563) [/usr/lib/osp/libosp-uifw.so] + 0x2aa563
22: Tizen::Ui::Controls::_FrameImpl::OnAttachedToMainTree() + 0xa (0xb3cfd5e7) [/usr/lib/osp/libosp-uifw.so] + 0x4655e7
23: Tizen::Ui::_ControlManager::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0x76 (0xb3b518c7) [/usr/lib/osp/libosp-uifw.so] + 0x2b98c7
24: Tizen::Ui::_ControlManager::ActivateWindow(Tizen::Ui::_Window&, bool) + 0xcc (0xb3b522f5) [/usr/lib/osp/libosp-uifw.so] + 0x2ba2f5
25: Tizen::Ui::_ControlManager::OpenWindow(Tizen::Ui::_Window&, bool) + 0x2e (0xb3b52507) [/usr/lib/osp/libosp-uifw.so] + 0x2ba507
26: Tizen::Ui::_Window::Open(bool) + 0x3c (0xb3b3f821) [/usr/lib/osp/libosp-uifw.so] + 0x2a7821
27: Tizen::Ui::_WindowImpl::Open(bool) + 0x12 (0xb3b4f897) [/usr/lib/osp/libosp-uifw.so] + 0x2b7897
28: Tizen::App::_UiAppImpl::AddFrame(Tizen::Ui::Controls::Frame const&) + 0x40 (0xb3ef7f35) [/usr/lib/osp/libosp-uifw.so] + 0x65ff35
29: Tizen::App::UiApp::AddFrame(Tizen::Ui::Controls::Frame const&) + 0x14 (0xb3ef72f9) [/usr/lib/osp/libosp-uifw.so] + 0x65f2f9
30: MyHondanaApp::OnAppInitialized() + 0x88 (0xb2e9339c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0xb39c
31: Tizen::App::_UiAppImpl::OnAppInitialized() + 0x18 (0xb3ef77dd) [/usr/lib/osp/libosp-uifw.so] + 0x65f7dd
32: Tizen::App::_AppImpl::OnService(service_s*, void*) + 0x1da (0xb44aa39f) [/usr/lib/osp/libosp-appfw.so] + 0xf039f
33: (0xb428ebdd) [/usr/lib/libcapi-appfw-application.so.0] + 0x9bdd
34: (0xb6d92f28) [/usr/lib/libappcore-efl.so.1] + 0x2f28
35: (0xb529f94c) [/usr/lib/libappcore-common.so.1] + 0x194c
36: (0xb52a0024) [/usr/lib/libappcore-common.so.1] + 0x2024
37: (0xb652c1a9) [/usr/lib/libaul.so.0] + 0x31a9
dladdr failed 38: (0x818b0) (null)
End of Call Stack
