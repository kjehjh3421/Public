...
PID: 10597
Date: 2013-07-01 15:26:37(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 10597, uid 5000)
      TIMER: -2

Register Information
r0   = 0x00000000, r1   = 0xbe88a898
r2   = 0x00000000, r3   = 0x00000004
r4   = 0x001b6d30, r5   = 0x00000000
r6   = 0x00000000, r7   = 0xbe88a898
r8   = 0x00000004, r9   = 0xbe88aac4
r10  = 0x00000001, fp   = 0xbe88a970
ip   = 0xb4234ea4, sp   = 0xbe88a7d0
lr   = 0xb3c669fb, pc   = 0xb3d7f38c
cpsr = 0x280f0030
...
b065c000 b0e5b000 rwxp [stack:10599]
...
Callstack Information (PID:10597)
Call Stack Count: 36
 0: (0xb3d7f38c) [/usr/lib/osp/libosp-uifw.so] + 0x45638c
 1: Tizen::Ui::Controls::ContextMenu::Construct(Tizen::Graphics::FloatPoint const&, Tizen::Ui::Controls::ContextMenuStyle, Tizen::Ui::Controls::ContextMenuAnchorDirection) + 0x12 (0xb3c669fb) [/usr/lib/osp/libosp-uifw.so] + 0x33d9fb
 2: Tizen::Ui::Controls::ContextMenu::Construct(Tizen::Graphics::FloatPoint const&, Tizen::Ui::Controls::ContextMenuStyle) + 0x8 (0xb3c66a71) [/usr/lib/osp/libosp-uifw.so] + 0x33da71
 3: MyHondanaMainForm::SortMenu() + 0x1bc (0xb2f29bf0) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x10bf0
 4: MyHondanaMainForm::OnInitializing() + 0x80 (0xb2f29444) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x10444
 5: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb3bd3563) [/usr/lib/osp/libosp-uifw.so] + 0x2aa563
 6: Tizen::Ui::Controls::_FormImpl::OnAttachedToMainTree() + 0x28 (0xb3d8b6c9) [/usr/lib/osp/libosp-uifw.so] + 0x4626c9
 7: Tizen::Ui::_Control::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0xb2 (0xb3bbbdbf) [/usr/lib/osp/libosp-uifw.so] + 0x292dbf
 8: Tizen::Ui::_Control::EndAttaching(Tizen::Ui::_Control&) + 0xec (0xb3bbef19) [/usr/lib/osp/libosp-uifw.so] + 0x295f19
 9: Tizen::Ui::_Control::AttachChild(Tizen::Ui::_Control&) + 0x5a (0xb3bc190b) [/usr/lib/osp/libosp-uifw.so] + 0x29890b
10: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xa4 (0xb3bdea6d) [/usr/lib/osp/libosp-uifw.so] + 0x2b5a6d
11: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb3bb617b) [/usr/lib/osp/libosp-uifw.so] + 0x28d17b
12: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0xb3bb6207) [/usr/lib/osp/libosp-uifw.so] + 0x28d207
13: (0xb3e53b57) [/usr/lib/osp/libosp-uifw.so] + 0x52ab57
14: (0xb3e5449f) [/usr/lib/osp/libosp-uifw.so] + 0x52b49f
15: (0xb3e5701d) [/usr/lib/osp/libosp-uifw.so] + 0x52e01d
16: Tizen::Ui::Scenes::SceneManager::GoForward(Tizen::Ui::Scenes::ForwardSceneTransition const&, Tizen::Base::Collection::IList const*) + 0x18 (0xb3e4bb25) [/usr/lib/osp/libosp-uifw.so] + 0x522b25
17: MyHondanaFrame::OnInitializing() + 0x64 (0xb2f2855c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0xf55c
18: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb3bd3563) [/usr/lib/osp/libosp-uifw.so] + 0x2aa563
19: Tizen::Ui::Controls::_FrameImpl::OnAttachedToMainTree() + 0xa (0xb3d8e5e7) [/usr/lib/osp/libosp-uifw.so] + 0x4655e7
20: Tizen::Ui::_ControlManager::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0x76 (0xb3be28c7) [/usr/lib/osp/libosp-uifw.so] + 0x2b98c7
21: Tizen::Ui::_ControlManager::ActivateWindow(Tizen::Ui::_Window&, bool) + 0xcc (0xb3be32f5) [/usr/lib/osp/libosp-uifw.so] + 0x2ba2f5
22: Tizen::Ui::_ControlManager::OpenWindow(Tizen::Ui::_Window&, bool) + 0x2e (0xb3be3507) [/usr/lib/osp/libosp-uifw.so] + 0x2ba507
23: Tizen::Ui::_Window::Open(bool) + 0x3c (0xb3bd0821) [/usr/lib/osp/libosp-uifw.so] + 0x2a7821
24: Tizen::Ui::_WindowImpl::Open(bool) + 0x12 (0xb3be0897) [/usr/lib/osp/libosp-uifw.so] + 0x2b7897
25: Tizen::App::_UiAppImpl::AddFrame(Tizen::Ui::Controls::Frame const&) + 0x40 (0xb3f88f35) [/usr/lib/osp/libosp-uifw.so] + 0x65ff35
26: Tizen::App::UiApp::AddFrame(Tizen::Ui::Controls::Frame const&) + 0x14 (0xb3f882f9) [/usr/lib/osp/libosp-uifw.so] + 0x65f2f9
27: MyHondanaApp::OnAppInitialized() + 0x88 (0xb2f25258) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0xc258
28: Tizen::App::_UiAppImpl::OnAppInitialized() + 0x18 (0xb3f887dd) [/usr/lib/osp/libosp-uifw.so] + 0x65f7dd
29: Tizen::App::_AppImpl::OnService(service_s*, void*) + 0x1da (0xb453b39f) [/usr/lib/osp/libosp-appfw.so] + 0xf039f
30: (0xb431fbdd) [/usr/lib/libcapi-appfw-application.so.0] + 0x9bdd
31: (0xb6e23f28) [/usr/lib/libappcore-efl.so.1] + 0x2f28
32: (0xb533094c) [/usr/lib/libappcore-common.so.1] + 0x194c
33: (0xb5331024) [/usr/lib/libappcore-common.so.1] + 0x2024
34: (0xb65bd1a9) [/usr/lib/libaul.so.0] + 0x31a9
dladdr failed 35: (0x817d8) (null)
End of Call Stack
