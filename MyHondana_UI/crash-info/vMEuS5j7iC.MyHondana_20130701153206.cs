...
PID: 12211
Date: 2013-07-01 15:32:06(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 12211, uid 5000)
      TIMER: -2

Register Information
r0   = 0x00000000, r1   = 0x00002fb3
r2   = 0x00000006, r3   = 0x00002fb3
r4   = 0x00000006, r5   = 0xb6ca6be4
r6   = 0xb6ca6000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000814c0
...
Callstack Information (PID:12211)
Call Stack Count: 36
 ...
 4: Tizen::Ui::Control::RequestRedraw(bool) const + 0x3e (0xb3bb91ef) [/usr/lib/osp/libosp-uifw.so] + 0x2901ef
 5: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x168 (0xb2f2a294) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x11294
 6: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2f2b25c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x1225c
