...
PID: 18284
Date: 2013-07-01 16:31:18(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 18284, uid 5000)
      TIMER: -2

Register Information
r0   = 0x00000000, r1   = 0x0000476c
r2   = 0x00000006, r3   = 0x0000476c
r4   = 0x00000006, r5   = 0xb6ca6be4
r6   = 0xb6ca6000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00081898
r10  = 0xb6fe0000, fp   = 0xbe88ae58
ip   = 0xb6fe04c0, sp   = 0xbe88a7c8
...
00070000 0278a000 rw-p [heap]
af9d5000 af9d7000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b064f000 b0653000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b065c000 b0e5b000 rwxp [stack:18286]
...
Callstack Information (PID:18284)
Call Stack Count: 37
 ...
 5: MyHondanaMainForm::SortMenu() + 0x150 (0xb2f29be8) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x10be8
 6: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x154 (0xb2f2a52c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x1152c
 7: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2f2b180) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x12180
