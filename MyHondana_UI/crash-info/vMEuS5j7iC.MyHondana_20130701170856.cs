...
PID: 20660
Date: 2013-07-01 17:08:56(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 20660, uid 5000)
      TIMER: -2

Register Information
r0   = 0x00000000, r1   = 0x000050b4
r2   = 0x00000006, r3   = 0x000050b4
r4   = 0x00000006, r5   = 0xb6ca6be4
r6   = 0xb6ca6000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x02a88ab8
...
00070000 0399b000 rw-p [heap]
b025a000 b025c000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b064f000 b0653000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b065c000 b0e5b000 rwxp [stack:20662]
...
Callstack Information (PID:20660)
Call Stack Count: 37
 ...
 5: MyHondanaMainForm::SortMenu() + 0x150 (0xb2f29c3c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x10c3c
 6: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x154 (0xb2f2a580) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x11580
 7: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2f2b1d4) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x121d4
