...
PID: 19075
Date: 2013-07-02 18:00:25(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 19075, uid 5000)
      TIMER: -2

Register Information
r0   = 0xb45843e1, r1   = 0x00000000
r2   = 0xbf800000, r3   = 0x013962f8
...
Callstack Information (PID:19075)
Call Stack Count: 32
 ...
 5: SortPopupPanel::CreateItem(int, int) + 0x9cc (0xb2f2cec8) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x17ec8
 6: non-virtual thunk to SortPopupPanel::CreateItem(int, int) + 0x10 (0xb2f2d6f0) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x186f0
