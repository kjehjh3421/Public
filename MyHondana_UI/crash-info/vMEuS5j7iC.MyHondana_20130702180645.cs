...
PID: 20221
Date: 2013-07-02 18:06:45(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 20221, uid 5000)
      TIMER: -2

Register Information
r0   = 0xb45843e1, r1   = 0x00000000
r2   = 0xbf800000, r3   = 0x015062c0
r4   = 0xb45843e1, r5   = 0xccf79c46
r6   = 0x00000000, r7   = 0xb45843e1
r8   = 0xb4768ac8, r9   = 0xbe88a924
r10  = 0x00000000, fp   = 0x00000000
ip   = 0xb42353d4, sp   = 0xbe88a868
lr   = 0xb3f1179f, pc   = 0xb3f116f0
cpsr = 0x680f0030
...
00071000 0157f000 rw-p [heap]
ae443000 ae445000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b064b000 b064f000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0658000 b0e57000 rwxp [stack:20223]
...
Callstack Information (PID:20221)
Call Stack Count: 32
 0: Tizen::Graphics::_BitmapImpl::__CheckValidity(bool) + 0xb (0xb3f116f0) [/usr/lib/osp/libosp-uifw.so] + 0x5e86f0
 1: Tizen::Graphics::_BitmapImpl::CloneN(Tizen::Graphics::Bitmap const&) + 0x22 (0xb3f1179f) [/usr/lib/osp/libosp-uifw.so] + 0x5e879f
 2: (0xb3e16187) [/usr/lib/osp/libosp-uifw.so] + 0x4ed187
 3: (0xb3e06455) [/usr/lib/osp/libosp-uifw.so] + 0x4dd455
 4: Tizen::Ui::Controls::CustomItem::AddElement(Tizen::Graphics::Rectangle const&, int, Tizen::Graphics::Bitmap const&, Tizen::Graphics::Bitmap const*, Tizen::Graphics::Bitmap const*) + 0x78 (0xb3e01d19) [/usr/lib/osp/libosp-uifw.so] + 0x4d8d19
 5: SortPopupPanel::CreateItem(int, int) + 0x9cc (0xb2f2ced0) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x17ed0
 6: non-virtual thunk to SortPopupPanel::CreateItem(int, int) + 0x10 (0xb2f2d6f8) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x186f8
 7: (0xb3e17369) [/usr/lib/osp/libosp-uifw.so] + 0x4ee369
 8: (0xb3e190f5) [/usr/lib/osp/libosp-uifw.so] + 0x4f00f5
 9: (0xb3e366b1) [/usr/lib/osp/libosp-uifw.so] + 0x50d6b1
10: (0xb3e39653) [/usr/lib/osp/libosp-uifw.so] + 0x510653
11: (0xb3e3973b) [/usr/lib/osp/libosp-uifw.so] + 0x51073b
12: Tizen::Ui::Controls::_TableView::OnDraw() + 0xc (0xb3e1f5dd) [/usr/lib/osp/libosp-uifw.so] + 0x4f65dd
13: Tizen::Ui::_ControlImpl::OnDraw() + 0x10 (0xb3bd1835) [/usr/lib/osp/libosp-uifw.so] + 0x2a8835
14: (0xb3e1042d) [/usr/lib/osp/libosp-uifw.so] + 0x4e742d
15: Tizen::Ui::_Control::ControlVisualElementContentProvider::PrepareDraw(Tizen::Ui::Animations::VisualElement&) + 0xb6 (0xb3bce33b) [/usr/lib/osp/libosp-uifw.so] + 0x2a533b
16: Tizen::Ui::Animations::_VisualElementImpl::InvokePrepareDraw() + 0x16 (0xb3b5c477) [/usr/lib/osp/libosp-uifw.so] + 0x233477
17: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangle(Tizen::Graphics::FloatRectangle const&) + 0x2d4 (0xb3b5c789) [/usr/lib/osp/libosp-uifw.so] + 0x233789
18: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x70 (0xb3b5c8e1) [/usr/lib/osp/libosp-uifw.so] + 0x2338e1
19: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb3b5c983) [/usr/lib/osp/libosp-uifw.so] + 0x233983
20: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb3b5c983) [/usr/lib/osp/libosp-uifw.so] + 0x233983
21: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb3b5c983) [/usr/lib/osp/libosp-uifw.so] + 0x233983
22: Tizen::Ui::Animations::_VisualElementImpl::Draw() + 0x9e (0xb3b5caa7) [/usr/lib/osp/libosp-uifw.so] + 0x233aa7
23: Tizen::Ui::Animations::_DisplayManager::Render(Tizen::Ui::Animations::_RootVisualElement&) + 0x30 (0xb3b46f49) [/usr/lib/osp/libosp-uifw.so] + 0x21df49
24: Tizen::Ui::Animations::_DisplayManager::RenderAll() + 0x36 (0xb3b46ff7) [/usr/lib/osp/libosp-uifw.so] + 0x21dff7
25: (0xb3b68d69) [/usr/lib/osp/libosp-uifw.so] + 0x23fd69
26: (0xb66f6b2d) [/usr/lib/libecore.so.1] + 0x9b2d
27: (0xb66f7fff) [/usr/lib/libecore.so.1] + 0xafff
28: ecore_main_loop_begin + 0x30 (0xb66f8575) [/usr/lib/libecore.so.1] + 0xb575
29: elm_run + 0x6 (0xb6a2a6db) [/usr/lib/libelementary.so.1] + 0xa96db
30: appcore_efl_main + 0x114 (0xb6e27268) [/usr/lib/libappcore-efl.so.1] + 0x6268
31: app_efl_main + 0xc6 (0xb431fed3) [/usr/lib/libcapi-appfw-application.so.0] + 0x9ed3
End of Call Stack
