...
PID: 20625
Date: 2013-07-02 18:09:15(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 20625, uid 5000)
      TIMER: -2

Register Information
r0   = 0xb45843e1, r1   = 0x00000000
r2   = 0xbf800000, r3   = 0x01506290
...
b0658000 b0e57000 rwxp [stack:20627]
...
Callstack Information (PID:20625)
Call Stack Count: 32
 ...
 5: SortPopupPanel::CreateItem(int, int) + 0x9cc (0xb2f2cf1c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x17f1c
 6: non-virtual thunk to SortPopupPanel::CreateItem(int, int) + 0x10 (0xb2f2d744) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x18744
