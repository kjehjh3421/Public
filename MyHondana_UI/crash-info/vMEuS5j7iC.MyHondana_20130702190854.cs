...
PID: 22409
Date: 2013-07-02 19:08:54(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 22409, uid 5000)
      TIMER: -2

Register Information
r0   = 0x00000000, r1   = 0x00005789
r2   = 0x00000006, r3   = 0x00005789
r4   = 0x00000006, r5   = 0xb6ca6be4
r6   = 0xb6ca6000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00082918
r10  = 0xb6fe0000, fp   = 0xbe88add0
ip   = 0xb6fe04c0, sp   = 0xbe88a7e0
...
b2f15000 b2f34000 r-xp /opt/usr/apps/vMEuS5j7iC/bin/MyHondana.exe
...
Callstack Information (PID:22409)
Call Stack Count: 38
 ...
 4: Tizen::Ui::Controls::ListView::SetItemProvider(Tizen::Ui::Controls::IListViewItemProvider&) + 0x30 (0xb3e04721) [/usr/lib/osp/libosp-uifw.so] + 0x4db721
 5: SortPopupPanel::Construct(Tizen::Graphics::Rectangle) + 0xac (0xb2f2c1dc) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x171dc
 6: MyHondanaMainForm::SortMenu() + 0x120 (0xb2f28670) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x13670
 7: MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x158 (0xb2f27918) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x12918
 8: non-virtual thunk to MyHondanaMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x10 (0xb2f28744) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x13744
 9: (0xb3c86557) [/usr/lib/osp/libosp-uifw.so] + 0x35d557
10: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb459c649) [/usr/lib/osp/libosp-appfw.so] + 0x151649
11: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb459c883) [/usr/lib/osp/libosp-appfw.so] + 0x151883
12: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb459c975) [/usr/lib/osp/libosp-appfw.so] + 0x151975
13: (0xb3d7b15f) [/usr/lib/osp/libosp-uifw.so] + 0x45215f
14: (0xb3c83df3) [/usr/lib/osp/libosp-uifw.so] + 0x35adf3
15: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2bc (0xb459c649) [/usr/lib/osp/libosp-appfw.so] + 0x151649
16: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb459c883) [/usr/lib/osp/libosp-appfw.so] + 0x151883
17: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb459c975) [/usr/lib/osp/libosp-appfw.so] + 0x151975
18: Tizen::Ui::Controls::_Button::FireActionEvent() + 0x26 (0xb3c8d4b7) [/usr/lib/osp/libosp-uifw.so] + 0x3644b7
19: (0xb3c9003d) [/usr/lib/osp/libosp-uifw.so] + 0x36703d
20: Tizen::Ui::Controls::_Button::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0xe (0xb3c8b4b3) [/usr/lib/osp/libosp-uifw.so] + 0x3624b3
21: Tizen::Ui::_ControlImpl::CallOnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x21a (0xb3bd500f) [/usr/lib/osp/libosp-uifw.so] + 0x2ac00f
22: Tizen::Ui::_ControlImpl::_PropagatedTouchEventListener::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x20c (0xb3bdce49) [/usr/lib/osp/libosp-uifw.so] + 0x2b3e49
23: Tizen::Ui::_UiTouchEvent::FireListener(Tizen::Ui::_ITouchEventListener const*, Tizen::Ui::_Control const*, bool, bool&) + 0x1aa (0xb3c349c3) [/usr/lib/osp/libosp-uifw.so] + 0x30b9c3
24: Tizen::Ui::_UiTouchEvent::OnEventProcessing(Tizen::Ui::_Control const&, bool&) + 0x62 (0xb3c34dcf) [/usr/lib/osp/libosp-uifw.so] + 0x30bdcf
25: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb3c29477) [/usr/lib/osp/libosp-uifw.so] + 0x300477
26: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x78 (0xb3c29d51) [/usr/lib/osp/libosp-uifw.so] + 0x300d51
27: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x1ec (0xb3c29fdd) [/usr/lib/osp/libosp-uifw.so] + 0x300fdd
28: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0x8a (0xb3c2a0bf) [/usr/lib/osp/libosp-uifw.so] + 0x3010bf
29: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb3c2a14f) [/usr/lib/osp/libosp-uifw.so] + 0x30114f
30: (0xb3c1a213) [/usr/lib/osp/libosp-uifw.so] + 0x2f1213
31: (0xb3c1d8a3) [/usr/lib/osp/libosp-uifw.so] + 0x2f48a3
32: (0xb66f4aad) [/usr/lib/libecore.so.1] + 0x7aad
33: (0xb66f8153) [/usr/lib/libecore.so.1] + 0xb153
34: ecore_main_loop_begin + 0x30 (0xb66f8575) [/usr/lib/libecore.so.1] + 0xb575
35: elm_run + 0x6 (0xb6a2a6db) [/usr/lib/libelementary.so.1] + 0xa96db
36: appcore_efl_main + 0x114 (0xb6e27268) [/usr/lib/libappcore-efl.so.1] + 0x6268
37: app_efl_main + 0xc6 (0xb431fed3) [/usr/lib/libcapi-appfw-application.so.0] + 0x9ed3
End of Call Stack
