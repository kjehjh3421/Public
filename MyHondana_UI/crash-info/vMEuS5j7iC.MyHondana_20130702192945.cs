...
PID: 25908
Date: 2013-07-02 19:29:45(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 25908, uid 5000)
      TIMER: -2

Register Information
r0   = 0xb45843e1, r1   = 0x00000000
r2   = 0xbf800000, r3   = 0x01506350
...
b0658000 b0e57000 rwxp [stack:25910]
...
Callstack Information (PID:25908)
Call Stack Count: 32
 ...
 5: SortPopupPanel::CreateItem(int, int) + 0x970 (0xb2f2cc0c) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x17c0c
 6: non-virtual thunk to SortPopupPanel::CreateItem(int, int) + 0xc (0xb2f2d3f8) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x183f8
