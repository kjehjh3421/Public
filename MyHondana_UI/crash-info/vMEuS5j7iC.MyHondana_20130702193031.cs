...
PID: 26228
Date: 2013-07-02 19:30:31(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 26228, uid 5000)
      TIMER: -2

Register Information
r0   = 0xb45843e1, r1   = 0x00000000
r2   = 0xbf800000, r3   = 0x01506120
...
b0658000 b0e57000 rwxp [stack:26230]
...
Callstack Information (PID:26228)
Call Stack Count: 32
 ...
 5: SortPopupPanel::CreateItem(int, int) + 0x970 (0xb2f2cc08) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x17c08
 6: non-virtual thunk to SortPopupPanel::CreateItem(int, int) + 0xc (0xb2f2d3f4) [/opt/apps/vMEuS5j7iC/bin/MyHondana.exe] + 0x183f4
